...
$(function () {
    ...
    if (dt_basic_table.length) {
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var $status = {
                            ...
                            3: { title: 'Rejected', class: ' badge-light-success' },
                            4: { title: 'Resigned', class: ' badge-light-success' },
                            5: { title: 'Applied', class: ' badge-light-success' }
                        };
        ...
        $('div.head-label').html('<h6 class="mb-0">Pedidos tiangulares balanceados</h6>');
    }
