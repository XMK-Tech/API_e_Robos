@if (isset($pageConfigs['slug']) ? $slug = $pageConfigs['slug'] : $slug = '')
@endif
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        ...
                        <a class="dropdown-item {{ Route::currentRouteName() === 'app-access-profile' ? 'active' : '' }}" href="{{ Route::has('profile.show') ? route('profile.show') : 'javascript:void(0)' }}">
                            <i class="me-50" data-feather="user"></i> Meu perfil
                        </a>
                        <div class="dropdown-divider"></div>
                        @if (Auth::check() && Laravel\Jetstream\Jetstream::hasApiFeatures())
                        <a class="dropdown-item {{ Route::currentRouteName() === 'app-access-api' ? 'active' : '' }}" href="{{ route('api-tokens.index') }}">
                            <i class="me-50" data-feather="key"></i> API Tokens
                        </a>
                        @endif
                        <a class="dropdown-item {{ Route::currentRouteName() === 'app-access-atendimento' ? 'active' : '' }}" href="#">
                            <i class="me-50" data-feather="message-circle"></i> Atendimeto
                        </a>
                        <a class="dropdown-item {{ Route::currentRouteName() === 'app-access-ecommerces' ? 'active' : '' }}" href="#">
                            <i class="me-50" data-feather="shopping-cart"></i> e-Commerces
                        </a>


                        <a class="dropdown-item {{ Route::currentRouteName() === 'app-access-redes-sociais' ? 'active' : '' }}" href="#">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item {{ Route::currentRouteName() === $pageConfigs['slug'] ? 'active' : '' }}" href="{{ Auth::user() ? route('teams.show', Auth::user()->currentTeam->id) : 'javascript:void(0)' }}">
                            <i class="me-50" data-feather="settings"></i> Team Settings
                        </a>
                        @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                        <a class="dropdown-item {{ Route::currentRouteName() === $pageConfigs['slug'] ? 'active' : '' }}" href="{{ route('teams.create') }}">
