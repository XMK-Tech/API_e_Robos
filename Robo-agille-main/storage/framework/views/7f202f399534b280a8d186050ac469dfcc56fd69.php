<?php if(isset($pageConfigs['slug']) ? $slug = $pageConfigs['slug'] : $slug = ''): ?>
<?php endif; ?>
...
<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center <?php echo e($configData['navbarColor']); ?>" data-nav="brand-center">
        ...
        <ul class="nav navbar-nav">
            <li class="nav-item">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    ...
                    <h2 class="brand-text mb-0">Magicfiles</h2>
                </a>
            </li>
        </ul>
    </div>
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center <?php echo e($configData['navbarClass']); ?> navbar-light navbar-shadow <?php echo e($configData['navbarColor']); ?> <?php echo e($configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating'? 'container-xxl': ''); ?>">
        ...
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <!-- <ul class="nav navbar-nav bookmark-icons" style="max-height: 21.88px;">
                    <li class="nav-item d-none d-lg-block">
                        <h2 class="text me-2" style="margin-bottom: 5px; font-size: 1.4rem; color:white;">MAGICFILES</h2>
                    </li>

                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/email')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Email"><i class="ficon" data-feather="mail"></i></a></li>
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/chat')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Chat"><i class="ficon" data-feather="message-square"></i></a></li>
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/calendar')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Calendar"><i class="ficon" data-feather="calendar"></i></a></li>
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/todo')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Todo"><i class="ficon" data-feather="check-square"></i></a></li>
                </ul> -->
                <!-- <ul class="nav navbar-nav">
                    <li class="nav-item d-none d-lg-block">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="list-item align-items-center">
                                <img class="d-block rounded me-1" src="<?php echo e(asset('images/pages/eCommerce/1.png')); ?>" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1">
                                    <i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">
                                                Apple
                            ...
                            <div class="list-item align-items-center">
                                <img class="d-block rounded me-1" src="<?php echo e(asset('images/pages/eCommerce/7.png')); ?>" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1">
                                    <i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">
                            ...
                            <div class="list-item align-items-center">
                                <img class="d-block rounded me-1" src="<?php echo e(asset('images/pages/eCommerce/2.png')); ?>" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1">
                                    <i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">
                            ...
                            <div class="list-item align-items-center">
                                <img class="d-block rounded me-1" src="<?php echo e(asset('images/pages/eCommerce/3.png')); ?>" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1">
                                    <i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">
                            ...
                            <div class="list-item align-items-center">
                                <img class="d-block rounded me-1" src="<?php echo e(asset('images/pages/eCommerce/5.png')); ?>" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1">
                                    <i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">
                        ...
                        <li class="dropdown-menu-footer">
                            ...
                            <a class="btn btn-primary w-100" href="<?php echo e(url('app/ecommerce/checkout')); ?>">Checkout</a>
                        </li>
                    </ul>
                </li>
                        ...
                        <li class="scrollable-container media-list">
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar">
                                            <img src="<?php echo e(asset('images/portrait/small/avatar-s-15.jpg')); ?>" alt="avatar" width="32" height="32">
                                        </div>
                                    </div>
                                    <div class="list-item-body flex-grow-1">
                            ...
                            <a class="d-flex" href="javascript:void(0)">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar">
                                            <img src="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>" alt="avatar" width="32" height="32">
                                        </div>
                                    </div>
                                    <div class="list-item-body flex-grow-1">
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true">
                        <div class="user-nav d-sm-flex d-none">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings font-medium-4">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <h6 class="dropdown-header text-center">Configurações</h6>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item <?php echo e(Route::currentRouteName() === 'app-access-profile' ? 'active' : ''); ?>" href="<?php echo e(Route::has('profile.show') ? route('profile.show') : 'javascript:void(0)'); ?>">
                            <i class="me-50" data-feather="user"></i> Meu perfil
                        </a>
                        <div class="dropdown-divider"></div>
                        <?php if(Auth::check() && Laravel\Jetstream\Jetstream::hasApiFeatures()): ?>
                        <a class="dropdown-item <?php echo e(Route::currentRouteName() === 'app-access-api' ? 'active' : ''); ?>" href="<?php echo e(route('api-tokens.index')); ?>">
                            <i class="me-50" data-feather="key"></i> API Tokens
                        </a>
                        <?php endif; ?>
                        <a class="dropdown-item <?php echo e(Route::currentRouteName() === 'app-access-atendimento' ? 'active' : ''); ?>" href="#">
                            <i class="me-50" data-feather="message-circle"></i> Atendimeto
                        </a>
                        <a class="dropdown-item <?php echo e(Route::currentRouteName() === 'app-access-ecommerces' ? 'active' : ''); ?>" href="#">
                            <i class="me-50" data-feather="shopping-cart"></i> e-Commerces
                        </a>


                        <a class="dropdown-item <?php echo e(Route::currentRouteName() === 'app-access-redes-sociais' ? 'active' : ''); ?>" href="#">
                            <i class="me-50" data-feather="share-2"></i> Redes Sociais
                        </a>
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item <?php echo e(Route::currentRouteName() === $pageConfigs['slug'] ? 'active' : ''); ?>" href="<?php echo e(Auth::user() ? route('teams.show', Auth::user()->currentTeam->id) : 'javascript:void(0)'); ?>">
                        ...
                        <a class="dropdown-item <?php echo e(Route::currentRouteName() === $pageConfigs['slug'] ? 'active' : ''); ?>" href="<?php echo e(route('teams.create')); ?>">
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" aria-haspopup="true">
                        <div class="user-nav d-sm-flex d-none">
                        ...
                        <span class="avatar">
                            <img class="round" src="<?php echo e(Auth::user() ? Auth::user()->profile_photo_url : asset('images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar" height="30" width="30">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        ...
                        <a class="dropdown-item" href="<?php echo e(Route::has('profile.show') ? route('profile.show') : 'javascript:void(0)'); ?>">
                            <i class="me-50" data-feather="user"></i> Conta
                        </a>
                        <?php if(Auth::check() && Laravel\Jetstream\Jetstream::hasApiFeatures()): ?>
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion">
            <a class="d-flex align-items-center justify-content-between w-100" href="<?php echo e(url('app/file-manager')); ?>">
                <div class="d-flex">
                    <div class="me-75">
                        <img src="<?php echo e(asset('images/icons/doc.png')); ?>" alt="png" height="32">
                    </div>
                    <div class="search-data">
    ...
    <!-- END: Header-->
<?php /**PATH /home/u657453689/domains/minhaellementar.com.br/public_html/agille/entrega/resources/views/panels/navbar.blade.php ENDPATH**/ ?>