<?php $__env->startSection('title', 'DITR'); ?>
    ...
    <div class="bs-stepper-content">
      <div id="account-details-modern" class="content" role="tabpanel" aria-labelledby="account-details-modern-trigger">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form action="/import-pdf-ditr" method="POST" class="dropzone dropzone-area" id="dpz-imoveis-files-dirt" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
      ...
      <div id="personal-info-modern" class="content" role="tabpanel" aria-labelledby="personal-info-modern-trigger">
        ...
        <div class="d-flex justify-content-between">
          ...
          <button class="btn btn-success" id="confirm-ditr" disabled>
      ...
      <div id="social-links-modern" class="content" role="tabpanel" aria-labelledby="social-links-modern-trigger">
        ...
        <div class="d-flex justify-content-between">
          ...
          <a href="ditr-file-uploader" class="btn btn-info"><i data-feather='refresh-cw' class="align-middle me-sm-25 me-0"></i> Reiniciar</a>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u657453689/domains/minhaellementar.com.br/public_html/agille/entrega/resources/views//content/converters/ditr/ditr-file-uploader.blade.php ENDPATH**/ ?>