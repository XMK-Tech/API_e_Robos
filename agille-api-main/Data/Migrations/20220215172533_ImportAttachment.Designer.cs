...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220215172533_ImportAttachment")]
    partial class ImportAttachment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bfe8cfff-0dd8-4271-b55e-9ddc53422824"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 11, DateTimeKind.Local).AddTicks(4228),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("c69c3fa2-354e-4077-b8d5-4db103dc35a7"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7140),
                        ...
                        new
                        {
                            Id = new Guid("430a1a14-17b6-4ee3-a111-222d20d8fe2f"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7704),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b3387bd8-6850-467e-978e-370d9ec26b9c"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7713),
                        ...
                        new
                        {
                            Id = new Guid("a5c5b37d-9006-4de9-a290-70a4013d06d6"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7800),
                        ...
                        new
                        {
                            Id = new Guid("a6f29505-803c-46c9-8447-a6e3420853c2"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7810),
                        ...
                        new
                        {
                            Id = new Guid("b8448b49-7522-4038-ae2e-b269767dbfb9"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7814),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("70ef6162-6375-4ede-87e3-c752f83eb3de"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7823),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("84622185-ee74-4fe2-bc1b-15bae72e7ebe"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 14, 25, 33, 14, DateTimeKind.Local).AddTicks(7838),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.ImportFile", b =>
                {
                    b.HasOne("AgilleApi.Domain.Entities.Attachment", null)
                        .WithOne()
