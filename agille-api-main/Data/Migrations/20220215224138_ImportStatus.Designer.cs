...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220215224138_ImportStatus")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f75e6411-b607-42b5-b345-7cef78244597"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 449, DateTimeKind.Local).AddTicks(8531),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ac365b92-e385-4d8a-84e2-cc1c8525d253"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8109),
                        ...
                        new
                        {
                            Id = new Guid("6a879de8-da85-4365-81d0-f1567433c1a3"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8186),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a3e72006-aa1b-4608-8d66-0abc09815b3b"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8191),
                        ...
                        new
                        {
                            Id = new Guid("0c4dd5e9-b343-49cb-9791-39e009a0aeb2"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8193),
                        ...
                        new
                        {
                            Id = new Guid("9876109f-049f-47b4-8d27-1af13ab87680"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8195),
                        ...
                        new
                        {
                            Id = new Guid("257cbbab-b361-41d3-a924-53c62196b157"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8198),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("11493562-ad09-4caa-8558-9ab40658e10d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8209),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a9bf1842-483d-45b1-8f8e-4eec4019a158"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 15, 19, 41, 38, 450, DateTimeKind.Local).AddTicks(8212),
