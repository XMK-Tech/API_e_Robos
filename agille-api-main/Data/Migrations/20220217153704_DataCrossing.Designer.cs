...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220217153704_DataCrossing")]
    partial class DataCrossing
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a6adfd44-d991-40aa-9470-e8952abc317c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 159, DateTimeKind.Local).AddTicks(8755),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("8057d53c-d625-4b9e-a0c3-bd767e4939eb"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9653),
                        ...
                        new
                        {
                            Id = new Guid("f00549c3-2160-49f5-b810-7f407467b5d2"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9749),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4c257b36-79ab-4eda-8d58-f84d7d3d4c04"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9753),
                        ...
                        new
                        {
                            Id = new Guid("54872ec9-6c0e-4cd0-a3d1-a34e44e01c75"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9756),
                        ...
                        new
                        {
                            Id = new Guid("ca5d1511-c7dc-46cc-8812-26aae89d967d"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9758),
                        ...
                        new
                        {
                            Id = new Guid("14f27a7f-9dee-442f-8dc5-e69d7fae1215"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9761),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("948e2fc9-2de4-49d0-a672-38405ef85e8c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9763),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("92ad0134-ac08-4f62-87aa-f924e439a3b5"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 12, 37, 4, 160, DateTimeKind.Local).AddTicks(9773),
