...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220217170529_DataCrossingFix")]
    partial class DataCrossingFix
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9ffacfaa-2022-41c5-aff8-64ff050ac66c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 364, DateTimeKind.Local).AddTicks(4744),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("6a7c9c8d-746b-4cad-8e08-8fb2a06e5cac"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5665),
                        ...
                        new
                        {
                            Id = new Guid("1237dc6e-18e2-488f-8a86-740fc7bc8e87"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5755),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("2909cdfb-77ff-464b-acfb-9a0b6d75a11d"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5759),
                        ...
                        new
                        {
                            Id = new Guid("a406961f-23a9-46f7-b580-e515d888bc4f"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5762),
                        ...
                        new
                        {
                            Id = new Guid("50ee6dde-310b-433d-8d44-10c407318973"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5764),
                        ...
                        new
                        {
                            Id = new Guid("32d6fc98-fd56-40dd-a727-c2aeaae0e7f7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5766),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("4a616d71-5899-4d27-a4d6-39d6a1ba9479"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5779),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6b206313-ff7a-4598-971b-e159cdfb5897"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 14, 5, 28, 365, DateTimeKind.Local).AddTicks(5782),
