...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220217211743_IsSimplified")]
    partial class IsSimplified
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a86faea-d13d-44af-88ce-7dae865e7573"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 522, DateTimeKind.Local).AddTicks(2394),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("00933f2c-58eb-47da-9ab2-97817c0cd1ad"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4294),
                        ...
                        new
                        {
                            Id = new Guid("87987e48-54aa-4c6d-9603-91d5f905ec5b"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4406),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c4e67111-c856-476c-9106-1052f709fc44"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4410),
                        ...
                        new
                        {
                            Id = new Guid("3687abf4-7fc6-4294-ae1f-21562bdd261b"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4413),
                        ...
                        new
                        {
                            Id = new Guid("c902e021-49e4-4dee-bf15-9da299a62a60"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4416),
                        ...
                        new
                        {
                            Id = new Guid("23e622ba-78cf-470e-a526-a5497a719bad"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4419),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("c7e44c94-97d3-4a6f-9563-7d1de9237eb7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4434),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("3915e470-ed6b-492c-b181-9d2edefe18cd"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 17, 18, 17, 42, 523, DateTimeKind.Local).AddTicks(4437),
