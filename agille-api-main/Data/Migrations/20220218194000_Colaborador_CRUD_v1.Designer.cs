...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220218194000_Colaborador_CRUD_v1")]
    partial class Colaborador_CRUD_v1
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7f370c8b-9efe-4906-a039-ace9377909c8"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 596, DateTimeKind.Local).AddTicks(5028),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("aa671baa-af5a-420b-ab83-d0fae8faf44e"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2193),
                        ...
                        new
                        {
                            Id = new Guid("70c66fac-f32d-47d3-8b5e-75307939f325"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2438),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4a0e0ffc-6998-4149-8ed0-f632625b3dad"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2452),
                        ...
                        new
                        {
                            Id = new Guid("f0b7fc26-d567-4a14-88cd-8e43502ab831"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2523),
                        ...
                        new
                        {
                            Id = new Guid("419a66cc-f33b-41ed-8af9-eab6bc4fae40"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2532),
                        ...
                        new
                        {
                            Id = new Guid("fc2b5714-98d4-48bd-9669-8d0da67ff6e9"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2541),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("db7e3640-9862-49d6-9194-f6eb643dafa7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2546),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("762647bf-a654-4966-a9a4-361108d4f6ee"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 16, 39, 59, 602, DateTimeKind.Local).AddTicks(2551),
