...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220218211512_DataCrossingResponsible")]
    partial class DataCrossingResponsible
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2512d9bd-c9ca-4380-9c12-2dea77f00412"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 617, DateTimeKind.Local).AddTicks(5867),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("5b522540-42a4-4434-9ab7-edcaba2cbab7"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6516),
                        ...
                        new
                        {
                            Id = new Guid("4122dd41-adf2-49ae-8f8b-5add315b3682"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6603),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("47a62261-4f43-4e28-bb5c-6e5cd7a7587b"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6606),
                        ...
                        new
                        {
                            Id = new Guid("0e878d46-ac9a-4ffd-a22c-a387b128e9b0"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6609),
                        ...
                        new
                        {
                            Id = new Guid("01fc4efc-d9cb-4bc8-878e-c49f7b5c1e60"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6622),
                        ...
                        new
                        {
                            Id = new Guid("684f1a3d-e1af-4c6a-8b23-24f140b32eb7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6624),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("a3537f57-19b6-4d5a-8b58-e5be7e5c31ee"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6626),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a82c554e-ebe3-4033-bf6f-4c0784a4c85a"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 18, 18, 15, 11, 618, DateTimeKind.Local).AddTicks(6629),
