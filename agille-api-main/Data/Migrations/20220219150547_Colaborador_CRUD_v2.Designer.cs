...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220219150547_Colaborador_CRUD_v2")]
    partial class Colaborador_CRUD_v2
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d25e6537-2f0f-47c8-994d-5a70918ba70f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 676, DateTimeKind.Local).AddTicks(6647),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("1349928a-a072-42cd-a7ea-369fa7da9321"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(5643),
                        ...
                        new
                        {
                            Id = new Guid("f4a5b5ac-5ada-4d2b-86c2-c7ed696aee54"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(5983),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("f1456285-df25-4a68-9770-662b02ea108c"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(6053),
                        ...
                        new
                        {
                            Id = new Guid("9d0f1cab-af1d-4f4d-bc2c-690bfd9a5d34"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(6063),
                        ...
                        new
                        {
                            Id = new Guid("de65c7ba-5348-48cc-9e00-c2e7652e0acc"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(6069),
                        ...
                        new
                        {
                            Id = new Guid("dd182ab0-a883-4b35-964a-ecb2331d9536"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(6075),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("a9f0e648-8767-440f-926b-a33e13db16b2"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(6080),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c84480b6-8af5-4496-a4da-b794a2a38ca5"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 19, 12, 5, 45, 686, DateTimeKind.Local).AddTicks(6085),
