...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220221181606_Colaborador_CRUD_v3")]
    partial class Colaborador_CRUD_v3
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f478a2d9-2eea-44b5-91f9-4b01f4459daa"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 336, DateTimeKind.Local).AddTicks(7362),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("effa1221-3806-496b-9140-398725db6ce3"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(754),
                        ...
                        new
                        {
                            Id = new Guid("daabf202-7dfc-42cb-9b70-29ee85eb4327"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(954),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6e2adaeb-ff5c-4cd3-ac33-a528cdf57149"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(964),
                        ...
                        new
                        {
                            Id = new Guid("ed3acb88-702b-4b76-926c-e7ff388b7e02"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(970),
                        ...
                        new
                        {
                            Id = new Guid("91355e0c-c83a-4671-8c65-96715ab73b91"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(976),
                        ...
                        new
                        {
                            Id = new Guid("1f3ba616-0b8c-479f-b6c7-5f649c829320"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(1033),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("05b94bc6-ebb8-44b6-96ce-3d80aa398572"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(1038),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c10e9ae5-30fc-4b32-b366-1c8b66565b0c"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 21, 15, 16, 4, 340, DateTimeKind.Local).AddTicks(1045),
