...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220223123025_Notice")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e4c0ee47-bb75-477b-8d70-6398414f026b"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 344, DateTimeKind.Local).AddTicks(7355),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("2a6728ba-4735-47f7-97a0-f3fadfa0f51e"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(7849),
                        ...
                        new
                        {
                            Id = new Guid("a71060b0-e9db-4543-b898-5746362d3a3d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(8102),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("cbfd1e7f-e5d5-4f22-bd24-290667f2e2da"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(8107),
                        ...
                        new
                        {
                            Id = new Guid("262584f8-c739-402a-89bc-cea098923d55"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(8109),
                        ...
                        new
                        {
                            Id = new Guid("e3174d5d-3bb5-4751-908b-b7fccdf1907c"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(8112),
                        ...
                        new
                        {
                            Id = new Guid("4c047b77-f73b-4e8e-bc5f-5778cf71474f"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(8114),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("82667613-3a6c-4b7d-9954-fd091ce43b82"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(8116),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4e11a7dd-314c-4db1-a25c-938f9bc5fff0"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 30, 25, 345, DateTimeKind.Local).AddTicks(8125),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DivergencyEntry", b =>
                {
                    ...
                    b.HasOne("AgilleApi.Domain.Entities.Notice", null)
