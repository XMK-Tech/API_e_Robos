...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220223125225_NoticeDivergencyEntry")]
    partial class NoticeDivergencyEntry
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c027379a-306a-447b-be4f-8a572ff7f461"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 662, DateTimeKind.Local).AddTicks(43),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("09154846-a0b3-4662-9119-f560f11f2048"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(702),
                        ...
                        new
                        {
                            Id = new Guid("be6f6f0f-fa04-4fb9-8a3b-c50f4c4f74b4"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(790),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("fafe5663-5669-47c4-93cd-3b143881129a"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(794),
                        ...
                        new
                        {
                            Id = new Guid("b69eddf2-648d-4fcf-aa65-f37d1e7c8fc1"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(797),
                        ...
                        new
                        {
                            Id = new Guid("a5b4fcee-2119-49aa-9c65-d618dc2a244b"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(799),
                        ...
                        new
                        {
                            Id = new Guid("d01ca534-7ee1-40a8-90d4-867c23e9dd65"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(812),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("34a7c493-8092-4b6a-b32e-6b76e7842042"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(815),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("09e7faf0-b7ff-49c0-a5e9-2d8b1438b2cf"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 9, 52, 24, 663, DateTimeKind.Local).AddTicks(817),
