...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220223191758_NoticeAttachment")]
    partial class NoticeAttachment
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6c7b634c-8ddc-4b71-9690-55618d4b9ff1"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 154, DateTimeKind.Local).AddTicks(9360),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("8a78b7b8-c749-4b59-9d9f-aa682b9788ee"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1851),
                        ...
                        new
                        {
                            Id = new Guid("110b0d33-dd50-492c-8d95-2f3283b83194"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1954),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("961c504b-f461-4fc0-ba01-09bbfe9f5ba0"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1959),
                        ...
                        new
                        {
                            Id = new Guid("379e4fb8-25bd-4438-a884-2cf483f1f01a"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1962),
                        ...
                        new
                        {
                            Id = new Guid("c168808f-b4a7-44ad-b271-e5a5351eeff2"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1965),
                        ...
                        new
                        {
                            Id = new Guid("ccc70706-1e4f-41cf-ad1c-712edd127640"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1968),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("3718e9d1-eec5-44c0-bd12-ee3f6771ffd6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1970),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("011fe994-2b1d-464f-a8a9-b7cb9a381df6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 23, 16, 17, 58, 156, DateTimeKind.Local).AddTicks(1981),
