...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220224222707_NoticeAliquotObservation")]
    partial class NoticeAliquotObservation
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("897a050f-818a-4c19-b41a-74de0738b269"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 259, DateTimeKind.Local).AddTicks(3963),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("78ba2284-40f6-4002-9cfd-74bc542ae819"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3572),
                        ...
                        new
                        {
                            Id = new Guid("13dfd941-a1bd-4d9d-92ae-7ebbb892236b"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3647),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("dbee62f3-e520-4694-85b5-4504a58c4b2f"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3651),
                        ...
                        new
                        {
                            Id = new Guid("ad6593bc-51c9-459b-94d1-a6f1dfbfb1d5"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3653),
                        ...
                        new
                        {
                            Id = new Guid("88a8ba16-c137-4212-8113-06fe33723ada"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3655),
                        ...
                        new
                        {
                            Id = new Guid("ebda47ea-2db7-429e-841d-a263e89e0db4"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3658),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("cfd776af-06c0-48f9-9334-f87dd1a3394b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3672),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("61c45116-1839-4d55-9c43-9d7cdac9d309"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 24, 19, 27, 7, 260, DateTimeKind.Local).AddTicks(3675),
