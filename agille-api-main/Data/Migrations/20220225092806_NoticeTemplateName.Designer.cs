...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220225092806_NoticeTemplateName")]
    partial class NoticeTemplateName
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2ebb54ca-0050-42ba-bd89-fae0b6dca11c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 786, DateTimeKind.Local).AddTicks(762),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("c60ab035-0fc9-4e0b-824d-1546ec04584c"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1013),
                        ...
                        new
                        {
                            Id = new Guid("9cfbf0b3-a38e-457d-b415-5e5a43d1fc11"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1099),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c95e95ce-0007-4ae9-9245-b0b2e1b76efc"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1103),
                        ...
                        new
                        {
                            Id = new Guid("437641e4-8a88-4a99-bf1b-c4a581e62ab0"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1105),
                        ...
                        new
                        {
                            Id = new Guid("078605a7-8080-4421-8bf1-5f8f83259512"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1108),
                        ...
                        new
                        {
                            Id = new Guid("bee404f2-d415-44d5-b383-e780f2aacef8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1110),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("fe91bdec-41bc-4c47-a5c9-c0138d6ff115"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1113),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c0b783b4-c113-4ca2-b5c1-b98e0a5cfa79"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 2, 25, 6, 28, 5, 787, DateTimeKind.Local).AddTicks(1124),
