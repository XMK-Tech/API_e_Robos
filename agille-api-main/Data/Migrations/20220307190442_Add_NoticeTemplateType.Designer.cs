...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220307190442_Add_NoticeTemplateType")]
    partial class Add_NoticeTemplateType
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("93cd57c7-1e4e-430a-a3cc-e2f672ecd846"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 714, DateTimeKind.Local).AddTicks(9153),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("09b4f278-383d-4af7-bac4-9091af648d19"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8168),
                        ...
                        new
                        {
                            Id = new Guid("356eefdd-1dd0-48ff-a0df-75ea6bbe0bda"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8247),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b46f2ac7-fc98-480e-9857-9e22b9d1d262"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8250),
                        ...
                        new
                        {
                            Id = new Guid("f3295492-26bd-4310-bbed-b9c60299b066"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8252),
                        ...
                        new
                        {
                            Id = new Guid("1a10ddd0-5e3b-4e3d-b6d3-4f003c9af896"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8255),
                        ...
                        new
                        {
                            Id = new Guid("1101be31-2dc3-4fe0-a82c-0f631b037461"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8257),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("7923a17a-cd6a-4398-ac66-2a3de50c4e3d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8265),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("9f78f1a5-0b05-4ea9-91b6-677a76f0146f"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 7, 16, 4, 41, 715, DateTimeKind.Local).AddTicks(8267),
