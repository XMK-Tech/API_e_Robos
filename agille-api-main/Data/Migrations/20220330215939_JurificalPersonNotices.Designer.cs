...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220330215939_JurificalPersonNotices")]
    partial class JurificalPersonNotices
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8caba80c-5b02-4990-8fda-aa3d072e469f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 729, DateTimeKind.Local).AddTicks(2874),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("289626d7-446c-448c-8c7d-69f9a56726ad"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7468),
                        ...
                        new
                        {
                            Id = new Guid("fef2d094-967d-4bbd-8cf4-08eef3af8b62"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7552),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1849e218-0c45-4522-a5cc-1fe39b3dd7a3"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7556),
                        ...
                        new
                        {
                            Id = new Guid("bf4d46bc-1042-4739-afb2-bae49afe5fda"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7558),
                        ...
                        new
                        {
                            Id = new Guid("f7a0e9ce-f2af-419d-8b4e-862d6f7379d5"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7560),
                        ...
                        new
                        {
                            Id = new Guid("2237f16d-9b60-47fe-9be3-23eb30429f4d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7562),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("ab8591bc-e1fd-4687-b37f-a5cf4177c791"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7564),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ec33f229-9ab1-40f4-b19e-e109c03d0a5d"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 3, 30, 18, 59, 38, 730, DateTimeKind.Local).AddTicks(7576),
