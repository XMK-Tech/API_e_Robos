...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220418175839_CreateTransactionType")]
    partial class CreateTransactionType
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9028599b-df2f-48c7-9be7-6f26ccc859cc"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 103, DateTimeKind.Local).AddTicks(6202),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("82135c9f-4856-4359-9579-30db552833e0"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4647),
                        ...
                        new
                        {
                            Id = new Guid("45a23180-b7d7-4252-89ee-5e7b49b96a01"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4717),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("109ac90f-884b-42b5-b967-2a7aefbaa765"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4720),
                        ...
                        new
                        {
                            Id = new Guid("c978a021-f1a7-4c82-9a62-903fdf494e2e"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4723),
                        ...
                        new
                        {
                            Id = new Guid("69f6d73c-4b90-4004-8808-e24271b15d05"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4725),
                        ...
                        new
                        {
                            Id = new Guid("87da6d0d-54b2-42e4-b30b-9f07b8fb976a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4735),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("40b37410-e7f6-4dff-948f-6e1b747fc01a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4739),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e770c720-e7ac-4334-b415-e42faf8c1b5d"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 18, 14, 58, 39, 104, DateTimeKind.Local).AddTicks(4741),
