...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220426224351_ItrMerge")]
    partial class ItrMerge
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4ffb9d68-0a1c-4bc3-aea8-a26b71cb54ba"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7245),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("f1b723e8-5052-4398-8b7d-31074114c5ec"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7261),
                        ...
                        new
                        {
                            Id = new Guid("fca26b5b-bd30-4829-b8d1-501bb447fbf8"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7266),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("0f6f1909-77d5-46b9-86cc-092155e21116"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7283),
                        ...
                        new
                        {
                            Id = new Guid("e8e5335b-06c7-418e-a18b-cb8a25e3e9f4"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7287),
                        ...
                        new
                        {
                            Id = new Guid("c3080984-4889-4a91-a8cf-5a8a585640f6"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7289),
                        ...
                        new
                        {
                            Id = new Guid("a17b8141-ace3-4017-b44f-d3accef7a640"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7291),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("5c67a79e-eeb3-48b7-98d0-664f352a5036"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7293),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("cdd5a586-491a-40b0-b3a7-2a28eadd54ea"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 26, 19, 43, 51, 45, DateTimeKind.Local).AddTicks(7294),
