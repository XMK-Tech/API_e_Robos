...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220428185747_AddCompanyCardRate")]
    partial class AddCompanyCardRate
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f6d5a51e-25a3-49fa-ad59-a271eba047ca"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3339),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("0a5f285d-e410-45cf-b34e-164a525bf540"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3352),
                        ...
                        new
                        {
                            Id = new Guid("1d1c0865-d7b1-46a4-a731-9886c79dcd66"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3354),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("40e86e3f-d654-46b0-a45d-b62df96af48f"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3356),
                        ...
                        new
                        {
                            Id = new Guid("10ffc789-5929-4a88-abe3-81b8f4c47045"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3358),
                        ...
                        new
                        {
                            Id = new Guid("67743fb0-7304-421c-83d4-7ed34969f8c7"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3360),
                        ...
                        new
                        {
                            Id = new Guid("231996a5-c211-4a6c-868a-5d59b01f6855"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3374),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("c3b2aa3d-b7ad-4533-9bf8-48ea67e0022c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3376),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b2b64c16-904b-4e43-99ef-5c39a065d0e6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 28, 15, 57, 47, 303, DateTimeKind.Local).AddTicks(3378),
