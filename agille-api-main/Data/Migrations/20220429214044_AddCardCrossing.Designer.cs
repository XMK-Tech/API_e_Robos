...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220429214044_AddCardCrossing")]
    partial class AddCardCrossing
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("36236022-f7a2-42d7-9a05-bf7c47103618"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1758),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("7dd5aa26-1f26-48c7-8a7a-04d537cbd8a0"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1770),
                        ...
                        new
                        {
                            Id = new Guid("f53f1464-006c-4074-b49f-59183791e32e"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1772),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("0e0f4a65-f961-498b-a17f-a37c42bc5749"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1773),
                        ...
                        new
                        {
                            Id = new Guid("e1b8857e-2eef-4189-9ef0-72ad8c724086"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1775),
                        ...
                        new
                        {
                            Id = new Guid("118792e3-45c4-41fe-8cc8-439e97b9dee1"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1786),
                        ...
                        new
                        {
                            Id = new Guid("22c6a9cd-2f52-4b95-89d2-86d4f5ea87e8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1787),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("5da9fee9-8096-4991-8e9e-dc51fdaa0245"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1789),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("393a7a2b-9773-4144-8024-91917709cd96"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 40, 44, 289, DateTimeKind.Local).AddTicks(1790),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.CardCrossing", b =>
                {
                    ...
                    b.HasOne("AgilleApi.Domain.Entities.User", "RequestingUser")
                        .WithMany()
