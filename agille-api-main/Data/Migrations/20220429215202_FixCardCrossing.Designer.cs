...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220429215202_FixCardCrossing")]
    partial class FixCardCrossing
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5b315ee8-583e-40e4-9530-e5f67c6f3056"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3037),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("2ccd4dc3-6f59-408c-ad69-593b2ace1aa2"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3070),
                        ...
                        new
                        {
                            Id = new Guid("14dd8627-52ec-417b-9090-4ac472144f42"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3075),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("91c38c07-26a6-45ae-94a0-2307e582b3d1"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3079),
                        ...
                        new
                        {
                            Id = new Guid("7cfb420d-0f43-407d-96b6-24215f2e3816"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3082),
                        ...
                        new
                        {
                            Id = new Guid("a496e8df-20a6-46a3-9c2f-9f7600678f94"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3086),
                        ...
                        new
                        {
                            Id = new Guid("83fbe9e4-f501-47af-97db-712423e5bd13"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3090),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("64a064cb-65fb-4a40-b1f9-d7e146e10940"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3094),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("07c2df0f-f696-4a75-92e6-83f9cbdcef02"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 4, 29, 18, 52, 2, 87, DateTimeKind.Local).AddTicks(3103),
