...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220524223940_FixCardCrossing_II")]
    partial class FixCardCrossing_II
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.CardCrossing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("AmountOnAverageRate")
                        .HasColumnType("float");

                    b.Property<double>("AmountOnDeclaredRate")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("DeclaredRate")
                        .HasColumnType("float");
                    ...
                    b.ToTable("CardCrossing", (string)null);
                });
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("236677ac-a1f2-4d7f-8435-bce7158f59ad"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6477),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("d74eb1e3-5106-4970-9bc3-ca0b1685d14e"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6488),
                        ...
                        new
                        {
                            Id = new Guid("aada6e77-e43a-4652-973e-318cf39bc4b3"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6490),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("45cbe9e2-6b5f-4f1f-9a09-8579e38d110b"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6492),
                        ...
                        new
                        {
                            Id = new Guid("10c1cd0e-9024-4ad3-a2cf-313bc9b8d570"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6494),
                        ...
                        new
                        {
                            Id = new Guid("89a1ab2f-859b-4606-b4d7-bf46d9ab7305"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6505),
                        ...
                        new
                        {
                            Id = new Guid("52e529f5-2c93-4e94-9bdc-c923c94e3e20"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6507),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("42a17c66-40e9-48dd-8d64-5a1304b87b6b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6508),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ebb6455b-e064-4019-befa-5b25afa9a642"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 24, 19, 39, 40, 257, DateTimeKind.Local).AddTicks(6510),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.CardCrossing", b =>
                {
                    b.HasOne("AgilleApi.Domain.Entities.JuridicalPersonBase", "Operator")
                        .WithMany()
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.CardCrossingReport", b =>
                {
                    b.HasOne("AgilleApi.Domain.Entities.User", "RequestedBy")
                        .WithMany()
