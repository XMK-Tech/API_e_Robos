...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220525161326_RemoveUserConstrait")]
    partial class RemoveUserConstrait
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2b0112d6-6656-4e54-bed8-e61deec51998"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2871),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("2405ae5d-e4fc-469e-ba76-9da9b4d65429"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2881),
                        ...
                        new
                        {
                            Id = new Guid("ee8d4ee0-2a1d-46fe-8221-d2529fddfc33"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2883),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("d98e7436-a601-4038-a3aa-a3eb957eba13"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2894),
                        ...
                        new
                        {
                            Id = new Guid("f4a291ab-d757-4fe2-bfab-89f0c195105b"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2895),
                        ...
                        new
                        {
                            Id = new Guid("fc11bfe6-b1b3-457e-af5b-ff674daaac37"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2897),
                        ...
                        new
                        {
                            Id = new Guid("3900dfb8-e3ec-4872-a47f-c8b7f1bdcdf3"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2899),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("729184de-6a2f-4d91-abfe-05f1bb1a3fc6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2900),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("22a0b1c3-6895-4460-bb34-58cecb100245"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 13, 13, 26, 491, DateTimeKind.Local).AddTicks(2902),
