...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220525203028_CardCrossingReference")]
    partial class CardCrossingReference
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f618f4d2-b85e-41dd-bdde-c1e441ece5bc"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1041),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("7df68cfe-7c34-4087-91a1-ccb249de99a9"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1053),
                        ...
                        new
                        {
                            Id = new Guid("dd37779a-bcc2-4e9b-b718-eb892dc761a2"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1061),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("47981f05-b8eb-45f1-96e6-876f473475db"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1062),
                        ...
                        new
                        {
                            Id = new Guid("3fb4be2b-1104-4e68-846e-84590a782a62"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1064),
                        ...
                        new
                        {
                            Id = new Guid("b08b146c-acde-42b4-8b35-6c422f309b98"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1065),
                        ...
                        new
                        {
                            Id = new Guid("cc17b435-a091-4b86-bdc8-409fb62cf72a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1067),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("b6afdc7d-2b76-45fa-b1c8-df8757232d7d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1069),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ec186830-ec7b-4df3-8446-2de09bae9d63"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 25, 17, 30, 27, 923, DateTimeKind.Local).AddTicks(1072),
