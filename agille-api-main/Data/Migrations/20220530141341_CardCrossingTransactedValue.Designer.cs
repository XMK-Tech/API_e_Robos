...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220530141341_CardCrossingTransactedValue")]
    partial class CardCrossingTransactedValue
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c04919e6-42c7-4b64-ac34-a3f038a1b6ab"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3640),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("e794f244-32db-43a2-af40-7d927cdbe8c5"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3651),
                        ...
                        new
                        {
                            Id = new Guid("fe5dd84f-0d13-42c4-8247-3e5962ff87ca"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3653),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("5fa36da4-77e0-4a4e-985a-2232de4465cf"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3654),
                        ...
                        new
                        {
                            Id = new Guid("d53633de-e0f3-4b20-b515-8bd3c9414149"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3655),
                        ...
                        new
                        {
                            Id = new Guid("8debddbb-a755-43b1-a140-639da0b0ff57"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3657),
                        ...
                        new
                        {
                            Id = new Guid("63580f10-08af-43ec-ab75-d4908bf00309"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3658),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("0c8e4c61-c4a8-450e-a079-ba5b48df3f89"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3673),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("22a62d11-959e-4b3a-9091-dc690d363d1d"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 30, 11, 13, 40, 84, DateTimeKind.Local).AddTicks(3674),
