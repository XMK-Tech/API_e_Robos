...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220531142223_CardDivergencyEntry")]
    partial class CardDivergencyEntry
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.CardCrossing", b =>
                {
                    ...
                    b.Property<decimal>("DeclaredTransactedValue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9dfe07c1-5bcc-49bf-a5c3-6455b778dbb2"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5672),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("3297d2dc-a4fe-4c3e-819d-a2031c5bf418"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5683),
                        ...
                        new
                        {
                            Id = new Guid("52c5353d-504d-420c-809b-95058c95f132"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5684),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("790cf7a4-a1b6-4783-9e22-c9e0847bd255"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5686),
                        ...
                        new
                        {
                            Id = new Guid("71d97eee-0a45-4229-9e22-567dadef72ac"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5692),
                        ...
                        new
                        {
                            Id = new Guid("41c0b725-d457-4afb-bf5d-8c967618dc70"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5694),
                        ...
                        new
                        {
                            Id = new Guid("67eb85d0-b017-4060-ace9-17b242cd1547"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5695),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("db9a82fa-acf0-4e6b-baca-9c631a4d221e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5697),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("abbf0962-1d81-4590-8d49-9ad44fc28138"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 11, 22, 22, 341, DateTimeKind.Local).AddTicks(5698),
