...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220531173714_CardDivergencyEntryII")]
    partial class CardDivergencyEntryII
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bb2ea101-80d9-4d58-a183-4b49dd86d57c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8035),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("eeb1d47a-18d5-4fe8-9377-4f30b9b6480f"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8046),
                        ...
                        new
                        {
                            Id = new Guid("a48c511c-9c51-4e0f-aed5-fa22b3b3fe2c"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8048),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("30653aa8-2281-4fea-85a2-1d06ddce7ea3"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8049),
                        ...
                        new
                        {
                            Id = new Guid("33cd84c3-7008-4ea0-a783-b4159a82ef70"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8050),
                        ...
                        new
                        {
                            Id = new Guid("6aa434d3-a2fe-4273-9eeb-be5109c4a8e6"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8052),
                        ...
                        new
                        {
                            Id = new Guid("2aa8b7d1-d1d3-4eb2-bd44-a5b20aa52ec8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8053),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("19929eb6-aa4f-41fe-86a4-989ed908e036"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8055),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("66d2a1f3-d3e7-409f-a3e5-97531541b6a3"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 5, 31, 14, 37, 12, 559, DateTimeKind.Local).AddTicks(8058),
