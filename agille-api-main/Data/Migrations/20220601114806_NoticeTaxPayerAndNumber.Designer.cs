...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220601114806_NoticeTaxPayerAndNumber")]
    partial class NoticeTaxPayerAndNumber
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("08074abf-ffb7-4015-9afb-aef9d5437301"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8629),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("7dd755e6-c5c3-4b4c-882d-7eaebdfa4019"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8643),
                        ...
                        new
                        {
                            Id = new Guid("b4b6da24-aeed-4887-8528-de4e19cd2344"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8645),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6e969bb2-9ad0-4c0e-9adf-7143defeb78a"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8646),
                        ...
                        new
                        {
                            Id = new Guid("d6c2f8f6-9047-4ed7-9011-a8bd3d12a743"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8647),
                        ...
                        new
                        {
                            Id = new Guid("b41386f2-9212-484a-ae3d-cb9127257d5d"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8649),
                        ...
                        new
                        {
                            Id = new Guid("33f986f8-f285-4a5c-ab47-5ad6274f425e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8658),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("dc6d2aa9-c348-4768-ae5f-ba746ca39e67"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8660),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c6e06d11-66e0-44de-badf-058a849f65cf"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 8, 48, 5, 784, DateTimeKind.Local).AddTicks(8661),
