...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220601142212_RemoveForeignKeyNotice")]
    partial class RemoveForeignKeyNotice
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b7d36eea-1825-46bc-bae6-421346d26023"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7337),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("fd815838-dbba-4642-9ce8-76b0cc9ffd42"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7350),
                        ...
                        new
                        {
                            Id = new Guid("d794f007-9515-41c8-9192-3441f1359897"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7351),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("40ea5a39-8712-420e-87bc-4814f5752a1e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7353),
                        ...
                        new
                        {
                            Id = new Guid("70fb1efd-a098-4394-8ba5-f7ffb4c79306"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7354),
                        ...
                        new
                        {
                            Id = new Guid("cfa57ff1-addb-4228-8e4a-1dccac6aa65a"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7355),
                        ...
                        new
                        {
                            Id = new Guid("1edbc52b-1069-4c2f-a971-4787fdfae71d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7356),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("0c823c4b-338b-4c62-9eb2-3ce3f0bf46c2"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7358),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("969d31a7-012b-4df8-925c-1dfc6a8b5fe0"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 1, 11, 22, 12, 397, DateTimeKind.Local).AddTicks(7361),
