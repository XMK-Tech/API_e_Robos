...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220602182801_DeleteOldNoticeNumber")]
    partial class DeleteOldNoticeNumber
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a6e1ba1e-38ab-4391-a37d-2f326ace659b"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(471),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("681abd7a-7d57-4302-be83-4e4dc5f44110"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(484),
                        ...
                        new
                        {
                            Id = new Guid("8b3322cd-c485-4a6c-acd1-4cd15198870c"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(486),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("02191cbb-b94d-4023-bc35-388f0a9fd5d1"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(488),
                        ...
                        new
                        {
                            Id = new Guid("d2b51e60-9b3a-4c3a-9669-56abf23674f1"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(490),
                        ...
                        new
                        {
                            Id = new Guid("6b134673-55db-4eed-874d-daa34b1fae59"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(501),
                        ...
                        new
                        {
                            Id = new Guid("505ba0a8-b1d7-4eaa-b722-eb5e96164ae5"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(503),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("55cdd6e2-84f2-4a5c-a917-e4b89790f584"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(505),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6e37902f-9e47-457e-b164-c1400ce2b0e6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 27, 59, 769, DateTimeKind.Local).AddTicks(511),
