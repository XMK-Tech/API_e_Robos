...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220602182848_Re-CreateNoticeNumber")]
    partial class ReCreateNoticeNumber
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6cac0b1c-88aa-4f80-8b4f-cb6acd6d834c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7558),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("68881c20-0682-42ef-8aa1-301a80261ad6"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7578),
                        ...
                        new
                        {
                            Id = new Guid("1de83833-ffb3-4981-840f-7830fa2e242b"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7580),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("2170eee8-9276-4b20-8062-aea4510fe60c"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7582),
                        ...
                        new
                        {
                            Id = new Guid("b069110e-d2f8-4771-94ab-c24d95f14088"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7583),
                        ...
                        new
                        {
                            Id = new Guid("7f51865f-84c8-4d85-99d1-2d7fc5826f5d"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7591),
                        ...
                        new
                        {
                            Id = new Guid("8a31ca68-5354-4ef5-abe6-6f89b555ac66"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7593),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("68320e13-a203-4f60-90ee-53d5e4fe869a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7595),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1239397d-4ef2-47ab-87cd-77df305d1236"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 15, 28, 46, 784, DateTimeKind.Local).AddTicks(7597),
