...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220602203831_NoticeDaysToExpire")]
    partial class NoticeDaysToExpire
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ed7fcc55-6ff7-4d48-b0d3-f62d94a894f5"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2453),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("710a0787-6759-49b7-8533-366d354baabb"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2473),
                        ...
                        new
                        {
                            Id = new Guid("faf606a7-3d8c-4cc6-811b-1de41a594f0c"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2475),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("cc68769e-6492-4a45-8574-89e8337f58b4"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2479),
                        ...
                        new
                        {
                            Id = new Guid("97f13a75-1307-4772-aca0-475f3e181265"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2480),
                        ...
                        new
                        {
                            Id = new Guid("a3a5d235-d4af-4eed-abbd-a1aeb54d042e"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2483),
                        ...
                        new
                        {
                            Id = new Guid("59e3dea9-0f90-4c34-9ff3-7114fb5fb215"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2484),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("832755a8-e3a7-48ba-96eb-406fb89d22f2"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2503),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("44fcf8aa-13e2-4ad1-8332-ef6dd0773b6b"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 2, 17, 38, 30, 343, DateTimeKind.Local).AddTicks(2505),
