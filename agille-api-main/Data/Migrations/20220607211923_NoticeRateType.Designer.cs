...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220607211923_NoticeRateType")]
    partial class NoticeRateType
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3cb63277-131f-410e-aa03-03e42ae00dfe"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1934),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("64c57a08-46e8-483a-a8d7-7157dd5d6792"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1946),
                        ...
                        new
                        {
                            Id = new Guid("05d17917-172b-4155-ad27-a57a38d2f76a"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1948),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("adf854c6-3e6f-487b-b730-e2dfa565ce10"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1949),
                        ...
                        new
                        {
                            Id = new Guid("a2e6f962-9610-451a-b29e-25df9290bfb4"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1966),
                        ...
                        new
                        {
                            Id = new Guid("b6994bf8-4b19-4425-ab66-8e8e7c3b7483"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1968),
                        ...
                        new
                        {
                            Id = new Guid("9c817d01-e6c1-491b-a2ff-a29c77b0df84"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1969),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("c108e28f-52db-462f-bca3-c78ad572e510"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1970),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("31498287-218d-4c93-b038-63123e3007d6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 7, 18, 19, 22, 608, DateTimeKind.Local).AddTicks(1972),
