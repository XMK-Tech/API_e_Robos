...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220610201438_ServiceType")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f57df8db-8634-44ed-83fb-24d07b4f16e3"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8396),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("97a763fe-db3d-4a4f-9699-a7baedf5c516"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8406),
                        ...
                        new
                        {
                            Id = new Guid("7820358a-23ac-46d6-831c-92399390cecf"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8408),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("5f9de0d8-31c7-4db7-ade0-9352433da151"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8409),
                        ...
                        new
                        {
                            Id = new Guid("4050a0b4-f238-4b79-9a88-5a9bea9f30e2"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8411),
                        ...
                        new
                        {
                            Id = new Guid("e6d071e4-343f-4e3d-85c4-57b610e81968"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8412),
                        ...
                        new
                        {
                            Id = new Guid("8be1e047-a5b6-4c9f-b1f6-4ef65c8837c8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8422),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("68062a64-aaa8-4448-b277-e2cf7b173099"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8423),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6bc8211a-b241-41e7-b814-6c90170ea0ce"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 17, 14, 37, 773, DateTimeKind.Local).AddTicks(8425),
