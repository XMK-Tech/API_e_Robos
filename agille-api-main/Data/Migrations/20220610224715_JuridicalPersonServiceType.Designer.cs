...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220610224715_JuridicalPersonServiceType")]
    partial class JuridicalPersonServiceType
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bb668874-f69d-41d8-8e60-1a43da424d09"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8726),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("36a9a977-1495-435c-97f1-661458aea733"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8740),
                        ...
                        new
                        {
                            Id = new Guid("c13df26b-7565-4ddd-a612-b8af050433fa"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8742),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("229a444c-ff4b-475e-a398-a9b9dc18e792"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8743),
                        ...
                        new
                        {
                            Id = new Guid("f2f0f4bc-a67b-4c7c-bccb-1a5755f58959"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8745),
                        ...
                        new
                        {
                            Id = new Guid("648c61dd-f62d-454f-93d9-04f6f6af4e6f"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8746),
                        ...
                        new
                        {
                            Id = new Guid("cc5f4960-722d-498b-9e0f-a06582dcd554"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8748),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("48660ec5-d0fc-4ff4-9cdb-e8ad995399c0"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8749),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6b356fbb-7ba8-428a-8b86-6175fe6df4f8"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 10, 19, 47, 13, 135, DateTimeKind.Local).AddTicks(8753),
