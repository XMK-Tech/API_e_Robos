...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220613190119_NoticeHistoric")]
    partial class NoticeHistoric
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5550e928-693d-43e9-a43d-779151dbdde0"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1205),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ce8f5214-762c-4937-889a-e67ed976fb48"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1216),
                        ...
                        new
                        {
                            Id = new Guid("8d0877fa-0d6b-44f8-a86e-5a8b8848cde0"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1218),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6b6f317f-2c18-42c3-b3f5-d47664d2e20e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1225),
                        ...
                        new
                        {
                            Id = new Guid("f2004e11-36f4-4d7b-80f9-dc70812902d6"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1226),
                        ...
                        new
                        {
                            Id = new Guid("9e359c90-b426-449c-bf5d-1444145fcfdf"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1228),
                        ...
                        new
                        {
                            Id = new Guid("87bbe3e1-d99d-432f-82fd-d1d4ead92526"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1229),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("ea5e6366-b23e-457f-b3ff-654117daca0c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1231),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("844113c6-421a-45fe-a42f-1aef8acd6f79"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 16, 1, 17, 682, DateTimeKind.Local).AddTicks(1232),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.NoticeHistoric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
