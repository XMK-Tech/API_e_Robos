...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220613200129_HistoricFix")]
    partial class HistoricFix
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3608fef0-3e5e-4491-8c80-4b098ef4c575"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7318),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("25a06c7a-1b34-40b2-a07b-104c3c9f1ca4"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7332),
                        ...
                        new
                        {
                            Id = new Guid("30bbc5ad-ba3e-4e92-84d8-b8669be8d12e"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7334),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("501ab48d-77a2-49d9-bb95-ffbb74b11e58"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7336),
                        ...
                        new
                        {
                            Id = new Guid("e5d261e1-f5a0-49ee-8866-fe0d5c42e6e7"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7348),
                        ...
                        new
                        {
                            Id = new Guid("9fdd8631-8cf6-4a9f-b4ac-fdb54b674437"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7350),
                        ...
                        new
                        {
                            Id = new Guid("5ed8570c-8ac0-4fa0-89de-c55d8b9a7b4a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7351),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("ffd5eee9-ab13-4374-a3c8-0b413615ca76"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7353),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c5a7268d-8a07-43bc-8230-73bcb8770b4c"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 17, 1, 27, 281, DateTimeKind.Local).AddTicks(7355),
