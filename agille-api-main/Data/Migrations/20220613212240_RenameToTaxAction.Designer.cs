...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220613212240_RenameToTaxAction")]
    partial class RenameToTaxAction
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("af536b8b-ca97-43b8-a13c-8635d206e5d8"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2955),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ca919442-2d88-4a99-b1e6-c0d23b49eab6"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2968),
                        ...
                        new
                        {
                            Id = new Guid("002240e1-c61b-4b96-9430-f395d93014cd"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2970),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("32247013-dd49-4ca6-889a-32fed5211d77"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2972),
                        ...
                        new
                        {
                            Id = new Guid("dc249cd1-12af-49d6-89c5-35626656e79e"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2973),
                        ...
                        new
                        {
                            Id = new Guid("f48a859f-4540-438e-bc9e-e8ca0b90647a"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2986),
                        ...
                        new
                        {
                            Id = new Guid("71668ac2-4a9d-450a-a203-fc7a880f1614"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2988),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("9849e75a-9f1a-4283-9a91-92f0176a4ae0"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2989),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a255eff4-5a19-426a-ae65-80409fc23318"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 18, 22, 38, 702, DateTimeKind.Local).AddTicks(2991),
