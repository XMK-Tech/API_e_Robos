...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220613222235_NoticeReturnProtocol")]
    partial class NoticeReturnProtocol
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("59267764-a5ea-4d17-916e-a333515bbadf"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4016),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("1c9dccb2-a496-42c9-af80-12957ecbd8a0"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4039),
                        ...
                        new
                        {
                            Id = new Guid("9482fc44-7bce-4894-b8c2-c6fedf93c908"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4041),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("49fd27d4-2980-4113-b4ce-073a083e47a8"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4042),
                        ...
                        new
                        {
                            Id = new Guid("5d5af863-a672-4e4b-9a9f-05a5262f309e"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4043),
                        ...
                        new
                        {
                            Id = new Guid("a5128c46-290b-4e91-a919-ab8c2129fa03"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4045),
                        ...
                        new
                        {
                            Id = new Guid("7646e183-3313-48bf-8721-2464c350e04c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4046),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("b7d6c574-06fe-466d-97ac-cc8f62b95026"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4068),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("3a9d4850-2f4c-4b01-80bc-df697b6e943c"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 13, 19, 22, 34, 168, DateTimeKind.Local).AddTicks(4069),
