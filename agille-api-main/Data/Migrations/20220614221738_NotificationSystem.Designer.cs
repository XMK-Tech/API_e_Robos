...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220614221738_NotificationSystem")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0ecb9436-691d-4e9e-b999-9129f354e05b"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1915),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("2bb67751-59e5-44e0-a292-d4a4e107708e"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1930),
                        ...
                        new
                        {
                            Id = new Guid("241cc93e-83cb-44d1-9bf8-43224389f8c3"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1942),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("56d85825-43d5-4730-ad29-0c53c99b99f3"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1944),
                        ...
                        new
                        {
                            Id = new Guid("30763c82-ce74-4325-96db-615a7ea72670"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1947),
                        ...
                        new
                        {
                            Id = new Guid("25e9e641-b6f1-420d-8315-0deefc9d6de5"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1949),
                        ...
                        new
                        {
                            Id = new Guid("b6803ad6-35a2-452f-bb8d-bbe0bda075dd"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1957),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("abbcbb63-34ed-41d7-99fc-ae2999fc86e1"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1960),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("0df539ef-51f2-415f-98fb-17d188046f3e"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 14, 19, 17, 37, 721, DateTimeKind.Local).AddTicks(1962),
