...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220615193609_ServiceTypeCode")]
    partial class ServiceTypeCode
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c91338e-b302-43e2-ae6e-95f0bb7547e2"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4807),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("84278a61-2838-4356-91e0-3ac1da206329"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4820),
                        ...
                        new
                        {
                            Id = new Guid("d9451a19-9c9a-4cc8-bb0c-f4c17fe71b8d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4822),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("56b049fa-895e-4064-83f8-50ac296e8e48"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4823),
                        ...
                        new
                        {
                            Id = new Guid("f9780f39-1b2c-4de3-933c-b74ef8202fe8"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4825),
                        ...
                        new
                        {
                            Id = new Guid("314401a9-5b4c-428a-a775-3a400838320a"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4840),
                        ...
                        new
                        {
                            Id = new Guid("9bac6ea6-0792-47e3-ab09-4b8ba99f1923"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4841),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("d525879c-f676-43d1-8762-f738141258f7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4843),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("f28f9362-0796-4cf1-99a5-937d808436d8"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 15, 16, 36, 7, 278, DateTimeKind.Local).AddTicks(4844),
