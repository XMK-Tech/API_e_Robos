...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220620134917_FixTaxpayer")]
    partial class FixTaxpayer
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4c448959-68cc-478a-b5b4-77a11ed7f8ba"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4769),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("f5aa6432-2208-4f6e-8341-6de38eb6994a"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4783),
                        ...
                        new
                        {
                            Id = new Guid("8e83e375-9d84-4322-bcb6-5fcf13e3a32a"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4794),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("289347a2-01a2-40e2-89e7-3550510933d5"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4795),
                        ...
                        new
                        {
                            Id = new Guid("15bd800b-a1d5-45e9-a627-5eb75edeb1a3"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4797),
                        ...
                        new
                        {
                            Id = new Guid("bd6c96d6-2e0b-463f-8321-0c3cdd6efa18"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4798),
                        ...
                        new
                        {
                            Id = new Guid("661e8cf7-52f8-4c9d-bb5b-4833aa5f7d30"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4800),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("66c5719c-cf94-4620-97a2-b8b2715911a8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4801),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ea2f4ced-4e31-4d27-8052-52d047c225b0"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 20, 10, 49, 17, 80, DateTimeKind.Local).AddTicks(4802),
