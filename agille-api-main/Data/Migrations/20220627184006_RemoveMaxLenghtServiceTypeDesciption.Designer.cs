...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220627184006_RemoveMaxLenghtServiceTypeDesciption")]
    partial class RemoveMaxLenghtServiceTypeDesciption
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6dab3616-ba7e-4cff-b3d2-022864d37e26"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4283),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("0530ffeb-cb2b-4b66-a5cc-66e166a40744"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4295),
                        ...
                        new
                        {
                            Id = new Guid("e795e981-dbdc-47e7-a1e8-b17f82526387"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4297),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e23e4dfb-5eae-476e-b1c0-86f5f1bcf47e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4298),
                        ...
                        new
                        {
                            Id = new Guid("8efece32-5d46-41ca-b400-1ab1e8271084"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4299),
                        ...
                        new
                        {
                            Id = new Guid("18121b3e-d16d-47a5-a319-0858ceb6b89e"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4301),
                        ...
                        new
                        {
                            Id = new Guid("39874350-bc04-4d3e-bdc5-8a65a220121b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4312),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("845adc3b-5b7d-4af6-9f32-229c59a1836e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4313),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("775609e1-4fde-4d54-aa03-afedfa8a7a68"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 15, 40, 4, 693, DateTimeKind.Local).AddTicks(4315),
