...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220627212620_ProprietyOwners")]
    partial class ProprietyOwners
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4240c5f3-9763-472a-9819-bdca3b3435d3"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4962),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("9a66d7e4-e005-4e6d-9b8e-91b1104405cc"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4973),
                        ...
                        new
                        {
                            Id = new Guid("369bbbf6-5f29-4eda-9cd1-e3ceec1506b8"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4985),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("610ac9b2-a0a6-4041-877a-31cde8397ffa"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4986),
                        ...
                        new
                        {
                            Id = new Guid("e0527ddd-2157-48f1-9154-fdeaeb63c7bb"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4994),
                        ...
                        new
                        {
                            Id = new Guid("078fe48e-d131-4818-926d-1c97d33e643a"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4995),
                        ...
                        new
                        {
                            Id = new Guid("8a03d284-5d94-4473-8cd2-12491fc72e89"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4996),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("62b0b154-dff3-46b6-9c7d-7cfccbb99f12"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4998),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c325f8c8-08b9-48c4-ba7e-f0e50da419d9"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 27, 18, 26, 18, 398, DateTimeKind.Local).AddTicks(4999),
