...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220629215321_TaxProcedureStage")]
    partial class TaxProcedureStage
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("faada050-983b-40b5-91f7-118ad23469dd"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7444),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("b3386b44-a848-4064-8f8f-a5fd6c1099b1"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7460),
                        ...
                        new
                        {
                            Id = new Guid("8458ac22-b218-488c-9a24-43247b0d9e8d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7461),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("bf174a1a-c389-48ae-ad95-6d3bc3ff53a3"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7463),
                        ...
                        new
                        {
                            Id = new Guid("21331873-7ed3-406d-8920-a887bbed03df"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7464),
                        ...
                        new
                        {
                            Id = new Guid("f9689929-f683-4df8-9245-261fa82f5844"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7465),
                        ...
                        new
                        {
                            Id = new Guid("b6335b8b-3446-4d07-8d87-9159cc42833a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7474),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("0b8bd282-c9ac-4163-a4f4-e996c6bae9f7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7476),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("00bf261b-8ec6-4cd9-9633-a32d7f9341cf"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 6, 29, 18, 53, 20, 81, DateTimeKind.Local).AddTicks(7478),
