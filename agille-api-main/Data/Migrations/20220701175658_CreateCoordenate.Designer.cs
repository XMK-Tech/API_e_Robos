...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220701175658_CreateCoordenate")]
    partial class CreateCoordenate
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b456c52f-ab5a-4ec2-a58b-b0fb4da8fb73"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9891),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("905942ff-a8be-4371-b1a5-9899f85d06ac"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9908),
                        ...
                        new
                        {
                            Id = new Guid("669433ba-162b-469f-ab59-991588653684"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9910),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1404606a-6e05-4c7c-af73-0f7f1fc56eb9"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9925),
                        ...
                        new
                        {
                            Id = new Guid("7e9cfb8e-ef65-4555-ba8f-98948cd76da1"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9926),
                        ...
                        new
                        {
                            Id = new Guid("edde2d60-5a3f-46bb-ad20-1bbbfe622dfb"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9928),
                        ...
                        new
                        {
                            Id = new Guid("29da66ac-fee8-4ded-829a-92f32c5a91bc"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9929),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("61201acf-0fcc-41d1-a805-985826d27610"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9931),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b6c5524c-bef0-48ab-ae2b-38c3d35d0df4"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 1, 14, 56, 57, 769, DateTimeKind.Local).AddTicks(9932),
