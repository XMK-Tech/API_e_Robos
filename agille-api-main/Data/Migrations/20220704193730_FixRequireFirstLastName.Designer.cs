...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220704193730_FixRequireFirstLastName")]
    partial class FixRequireFirstLastName
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("55eac420-8f89-4fe0-bf8f-387f502f50a0"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9768),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("1b392f61-ff81-40c5-bba9-b6268c7e32e2"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9781),
                        ...
                        new
                        {
                            Id = new Guid("2e7a0e6d-5c7d-40c7-9522-9a9ba940d9c9"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9783),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("bf41f715-efa4-4a30-987c-520a7bbaddcd"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9785),
                        ...
                        new
                        {
                            Id = new Guid("5cf6cc4c-878e-4617-8722-126b90acc270"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9786),
                        ...
                        new
                        {
                            Id = new Guid("80cc198b-dab0-40e3-af64-9bb5b6732511"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9788),
                        ...
                        new
                        {
                            Id = new Guid("9a8fa397-830a-4008-bc06-e73714180889"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9789),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("c93e5924-730a-40f4-a876-f8f3ae0facc6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9790),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b4dae7fe-b71c-4b89-b535-457344faabb0"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 4, 16, 37, 28, 337, DateTimeKind.Local).AddTicks(9794),
