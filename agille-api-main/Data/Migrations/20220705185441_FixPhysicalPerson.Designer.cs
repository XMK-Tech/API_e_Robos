...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220705185441_FixPhysicalPerson")]
    partial class FixPhysicalPerson
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5cd52d3b-e5df-4a3d-800f-997fa54c8459"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(149),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("8ba4780d-6a99-437d-831b-965eefdcc9a3"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(167),
                        ...
                        new
                        {
                            Id = new Guid("71d90443-c133-476d-9cfa-88a5b2f1eca8"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(169),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("9fc6deda-85fa-4751-8d67-298ccc9cb9da"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(182),
                        ...
                        new
                        {
                            Id = new Guid("4685711c-9a5b-4975-b1c2-ca96e86ec4be"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(185),
                        ...
                        new
                        {
                            Id = new Guid("b06ad924-5c54-4636-ad73-3b42fb4d3173"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(187),
                        ...
                        new
                        {
                            Id = new Guid("8dbeab96-04fe-4728-bae5-6b541e920ada"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(189),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("f53869b1-95ea-479a-9922-7eb941f98dde"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(191),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("89ad4beb-0bd0-4494-8048-cc9930f81d40"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 54, 39, 432, DateTimeKind.Local).AddTicks(192),
