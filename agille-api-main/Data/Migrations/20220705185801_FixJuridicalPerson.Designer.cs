...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220705185801_FixJuridicalPerson")]
    partial class FixJuridicalPerson
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9f2dc1fd-fc4e-4e49-a2be-87a56b61e084"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5021),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a8bffa3b-7697-47a3-ba07-d11db626798d"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5033),
                        ...
                        new
                        {
                            Id = new Guid("3e097112-4c7c-4347-affc-e23252324241"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5034),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("89db1ecc-5aca-4044-8280-73b3ad96c32e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5036),
                        ...
                        new
                        {
                            Id = new Guid("88c5b74b-12bd-46b8-a7df-bb064800d180"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5038),
                        ...
                        new
                        {
                            Id = new Guid("9b2819f3-f7ef-4476-8eb7-43d99b29da89"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5039),
                        ...
                        new
                        {
                            Id = new Guid("35af78fa-b296-491f-9d64-0076f9770b85"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5052),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("90ade9ea-27f9-4dc0-8154-b8eeb24fa728"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5053),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("0f60407a-e6f6-4991-b19a-fc1e883bb248"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 5, 15, 57, 59, 323, DateTimeKind.Local).AddTicks(5055),
