...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220711205221_ProprietyAttachments")]
    partial class ProprietyAttachments
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("42e8461f-99f4-4ac0-b7ce-cf3e0017ee96"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6741),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a2d06fe7-3345-415f-bd21-e2fafb145011"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6769),
                        ...
                        new
                        {
                            Id = new Guid("3cd155a9-2d69-4364-9c7b-daf7fb6da659"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6772),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("086f7798-bfd3-40e8-903d-87095a4bdce3"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6774),
                        ...
                        new
                        {
                            Id = new Guid("73ff7ab8-5078-4f25-9e16-703db56cbaa3"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6777),
                        ...
                        new
                        {
                            Id = new Guid("59a81721-c402-4dc0-abb7-2e915d8cb53e"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6799),
                        ...
                        new
                        {
                            Id = new Guid("b005041b-9e82-44a2-bad1-eb8381a5e046"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6802),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("7defdad7-fca1-488c-b85d-0535ac6369d4"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6804),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("cdcd9a6d-9189-4fd9-9b7b-5a203a260b3b"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 17, 52, 19, 52, DateTimeKind.Local).AddTicks(6806),
