...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220711210916_RemoveDependenciesRequirement")]
    partial class RemoveDependenciesRequirement
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cb6f8991-5459-4f2a-860c-870a10f2991f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8407),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("b3afb0d5-820e-4ad2-8922-7fa985044456"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8432),
                        ...
                        new
                        {
                            Id = new Guid("fe064e28-1cba-4dd4-8c5d-a9422bb361f0"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8433),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("7fbc588d-25b9-4ccc-99f8-e7388d66fc34"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8435),
                        ...
                        new
                        {
                            Id = new Guid("56559283-6ca0-451a-bd18-591ec4e59fbf"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8436),
                        ...
                        new
                        {
                            Id = new Guid("c9787d47-486e-429b-9801-97aae4bcfd93"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8437),
                        ...
                        new
                        {
                            Id = new Guid("87f45c48-4511-47ff-a0b4-041ea97dfb5f"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8459),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("ba7545dd-e0b6-4b74-8014-f8a6d2e67061"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8461),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("d1e9a74b-2ffe-4122-aeb7-c0ca96eef635"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 11, 18, 9, 14, 538, DateTimeKind.Local).AddTicks(8462),
