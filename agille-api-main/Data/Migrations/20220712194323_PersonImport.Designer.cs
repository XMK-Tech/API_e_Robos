...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220712194323_PersonImport")]
    partial class PersonImport
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2c1df0e0-6f1b-4292-a17c-132bfa91e7e6"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2605),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a24e763a-8780-4350-a430-35c5b6f636b7"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2618),
                        ...
                        new
                        {
                            Id = new Guid("a4c8d4e3-07c4-464f-adfd-0e0fc7dc586c"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2620),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c760a0a7-b5d6-4ae4-b333-818972e373f4"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2621),
                        ...
                        new
                        {
                            Id = new Guid("9df7ccce-0090-4832-aff5-eb086c3b181c"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2623),
                        ...
                        new
                        {
                            Id = new Guid("8b711da9-046b-40aa-a3e9-c2097046a3df"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2624),
                        ...
                        new
                        {
                            Id = new Guid("d8dc664e-c20a-44b3-a9d1-d7ad25219896"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2633),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("3581e975-eea2-4a61-8c19-405c111af825"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2634),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a5a868af-f6b0-43fd-8b42-3a0fbe55bc3f"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 16, 43, 21, 116, DateTimeKind.Local).AddTicks(2636),
