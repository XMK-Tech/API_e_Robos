...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220712222955_PersonProps")]
    partial class PersonProps
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3cddb23c-56bb-4ba3-a3e7-d8f6020c5e50"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5477),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ab740a0f-c98f-4d48-9190-932bdb674231"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5521),
                        ...
                        new
                        {
                            Id = new Guid("21c8fe5b-c67f-4058-ab6f-546f5fd01433"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5524),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("778a2a78-ec7d-42d5-a778-882ac63d1940"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5526),
                        ...
                        new
                        {
                            Id = new Guid("ec8e58c7-0c9c-45ec-a48d-46a210e9895b"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5528),
                        ...
                        new
                        {
                            Id = new Guid("42a2f4f7-c23e-40c7-a52f-3f30b8b68ff9"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5530),
                        ...
                        new
                        {
                            Id = new Guid("d82a352a-7b75-47ac-a1d2-8b596df22906"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5531),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("02ed19f0-7b45-4185-94eb-2c92849695e6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5533),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6fe21599-ab79-43f7-bfb1-c37c8b6761fd"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 12, 19, 29, 53, 881, DateTimeKind.Local).AddTicks(5534),
