...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220714181644_CreateTaxParam")]
    partial class CreateTaxParam
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aacdbc08-6a79-440a-9ec4-3a24b2351a47"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5521),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("3d641269-6cd1-499b-a505-04bd79058fba"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5540),
                        ...
                        new
                        {
                            Id = new Guid("9b6549f3-c589-4d06-a979-512a77c0eea7"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5542),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("32351e42-cf59-4ae5-aa58-85e50361b14e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5544),
                        ...
                        new
                        {
                            Id = new Guid("15492e72-20d6-401d-af82-2117a4045aec"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5547),
                        ...
                        new
                        {
                            Id = new Guid("a77f8096-5e1c-4a1d-af46-65a3277e59d1"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5549),
                        ...
                        new
                        {
                            Id = new Guid("6da2b120-2bbc-4efa-9801-3e73bc68654b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5563),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("1309abe4-59f0-4901-a161-b6c63ee77fa6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5566),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("8f6c73c1-c95e-44e6-8b89-10f96a701cf4"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 15, 16, 43, 591, DateTimeKind.Local).AddTicks(5570),
