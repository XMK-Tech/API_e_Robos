...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220714203119_UpdateTaxStage")]
    partial class UpdateTaxStage
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("771d8c6f-7607-40b6-8595-0e2bba26500a"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2323),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("73265ced-1862-42b7-b0c4-585982233fe5"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2341),
                        ...
                        new
                        {
                            Id = new Guid("5f3e9178-19a3-4f94-91ed-8634a03ee217"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2342),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ef818404-bb84-4cac-abfb-4a3da50eec66"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2349),
                        ...
                        new
                        {
                            Id = new Guid("b1237e2b-7c70-4065-8b09-a33574fb2409"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2351),
                        ...
                        new
                        {
                            Id = new Guid("8961e327-7581-4039-a033-3e31e624e3f2"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2353),
                        ...
                        new
                        {
                            Id = new Guid("3855b49b-09d6-4168-94a6-a644c1385420"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2354),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("d9ccecf9-4367-4696-bda7-b7fe3c4c3893"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2355),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6ea2b399-acca-4a82-9ff1-26622ba6d148"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 17, 31, 18, 152, DateTimeKind.Local).AddTicks(2357),
