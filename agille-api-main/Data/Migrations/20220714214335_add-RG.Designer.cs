...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220714214335_add-RG")]
    partial class addRG
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ff99eaa4-6f59-4122-944a-232aa2d6aa7f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9083),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("48de4812-1551-42f0-a2f6-9b849943b0db"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9098),
                        ...
                        new
                        {
                            Id = new Guid("f16e5446-9fde-4865-a6a7-525be32ddcab"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9100),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("402df71a-7c53-4a58-84d5-7b167e444d33"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9101),
                        ...
                        new
                        {
                            Id = new Guid("ad19d7a2-1c3c-48b9-9837-4e6f738b5a29"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9103),
                        ...
                        new
                        {
                            Id = new Guid("8d4a44e6-d372-48e7-98db-724f011fff7a"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9111),
                        ...
                        new
                        {
                            Id = new Guid("f7ed0b0f-ce65-4fd8-803b-c251f6093bfe"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9112),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("d06695c3-85a2-45b1-b25e-a6e9c35d6041"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9113),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("de295dba-5316-41f0-825a-1be37dd31760"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 18, 43, 33, 818, DateTimeKind.Local).AddTicks(9115),
