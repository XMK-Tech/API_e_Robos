...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220714224834_CreateTaxStageSubject")]
    partial class CreateTaxStageSubject
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("53f3871a-e7be-43df-8cad-c474c727b35f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(626),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("beb5927f-b674-40a4-b8eb-16fc3290b4e7"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(641),
                        ...
                        new
                        {
                            Id = new Guid("9ada0520-ee98-41fc-b860-50310ac24647"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(643),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("f6481f98-d7af-414f-98b8-4f49e327e504"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(645),
                        ...
                        new
                        {
                            Id = new Guid("75e3a09d-f23c-4a56-aa44-24813421d930"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(660),
                        ...
                        new
                        {
                            Id = new Guid("2044244f-958e-4a37-8b56-7db0aee934b3"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(662),
                        ...
                        new
                        {
                            Id = new Guid("cb379cd2-f37e-4703-a6e1-de2f467a9578"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(663),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("83872bd3-5908-488a-acd7-29e1793bcadc"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(664),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("5ac50e9b-6fab-4ae8-ac92-8eb9d4fa300d"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 14, 19, 48, 32, 52, DateTimeKind.Local).AddTicks(666),
