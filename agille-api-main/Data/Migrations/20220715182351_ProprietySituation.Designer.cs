...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220715182351_ProprietySituation")]
    partial class ProprietySituation
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d07e281f-0826-4218-a002-83984f0386ff"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(374),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("e845af8f-2a7b-4834-b7a5-e4a3ead9c882"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(387),
                        ...
                        new
                        {
                            Id = new Guid("dddc2e04-91ee-4427-a59c-c2d8cbfc3388"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(389),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("9fc427e2-0eeb-439b-8349-d78398f1f89c"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(391),
                        ...
                        new
                        {
                            Id = new Guid("db0c01b1-0d26-422b-97af-9e7427cb85f4"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(393),
                        ...
                        new
                        {
                            Id = new Guid("49812518-3060-48c4-a8fa-bda30e852998"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(394),
                        ...
                        new
                        {
                            Id = new Guid("3e00f16a-1149-4988-90e2-ec7da8e81121"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(395),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("4dbc6fa9-1ba9-422c-90b4-c9ddfee9ab96"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(405),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("801a9170-36af-4d39-8595-a74d3a805685"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 15, 15, 23, 49, 760, DateTimeKind.Local).AddTicks(407),
