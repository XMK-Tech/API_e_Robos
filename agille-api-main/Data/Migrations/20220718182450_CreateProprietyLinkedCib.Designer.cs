...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220718182450_CreateProprietyLinkedCib")]
    partial class CreateProprietyLinkedCib
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7cdb2560-8013-4079-bc48-790e3e5b4660"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9435),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("1cd71fa4-ec79-4d30-877d-1e53b21822d9"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9449),
                        ...
                        new
                        {
                            Id = new Guid("db4164be-8254-487a-9512-b116a8ed51b0"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9461),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c07396a6-ce62-4a3d-a31e-2df7ce13d83e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9462),
                        ...
                        new
                        {
                            Id = new Guid("c275acdd-8d9e-4e57-b357-25f998965db5"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9464),
                        ...
                        new
                        {
                            Id = new Guid("8c66513d-c41b-4305-8675-9ebbdf53cb16"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9465),
                        ...
                        new
                        {
                            Id = new Guid("bc183b83-b21c-4552-99df-89323d565a39"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9467),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("480c6b19-c31e-4685-8e84-7fb9c69f10c2"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9468),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a3589bef-b0fd-4e6d-b184-6782bf70c65d"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 15, 24, 48, 413, DateTimeKind.Local).AddTicks(9469),
