...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220718201225_AddressFunction")]
    partial class AddressFunction
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0938d8f1-6392-4faa-b799-3906ef2019a7"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4292),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("23111caa-f9d0-4886-b301-cdefab9cc372"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4311),
                        ...
                        new
                        {
                            Id = new Guid("b1479363-a797-4ed3-afbb-71c395223179"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4312),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("5687551c-695e-472b-8e40-aef2eb2e7cd4"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4314),
                        ...
                        new
                        {
                            Id = new Guid("022919e5-3b52-4ae7-b35e-f2443e00d623"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4316),
                        ...
                        new
                        {
                            Id = new Guid("f3b9c3b7-380c-4c07-9c42-c4aa409c69e8"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4317),
                        ...
                        new
                        {
                            Id = new Guid("6de42962-15a4-4520-bf99-5eb2928665c4"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4319),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("16827738-19ad-4292-bdc5-83f021ffd075"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4320),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e34ad880-3b0d-4419-a020-04718681da79"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 18, 17, 12, 23, 773, DateTimeKind.Local).AddTicks(4324),
