...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220719175644_FixSocialName")]
    partial class FixSocialName
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8be7d6ec-cf03-467b-8fb9-57e393c6e2c9"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(370),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("aeb95533-55fc-4dcf-9e35-0e7df35acdd7"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(403),
                        ...
                        new
                        {
                            Id = new Guid("14c4bdca-aa7a-4477-8c30-92b2affa1b0c"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(408),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("72dee710-8d2b-4b47-99b0-7c842ab2d7cf"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(413),
                        ...
                        new
                        {
                            Id = new Guid("6b4600af-013b-4888-82c9-68885c367d25"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(417),
                        ...
                        new
                        {
                            Id = new Guid("606bce93-a24f-4245-83f8-359b39ec5769"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(422),
                        ...
                        new
                        {
                            Id = new Guid("ea8e037a-be5a-474a-a20f-d7a0117650a3"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(455),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("e71e6e37-3ddf-4b48-b46e-3f4eedef283b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(460),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("fb547442-5041-4dea-a070-8dc72ebdf333"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 19, 14, 56, 41, 834, DateTimeKind.Local).AddTicks(464),
