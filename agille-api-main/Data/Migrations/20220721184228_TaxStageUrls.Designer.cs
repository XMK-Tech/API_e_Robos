...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220721184228_TaxStageUrls")]
    partial class TaxStageUrls
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b722de0a-0212-4c41-b299-d5f8b7b6b007"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4786),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("1712bbd4-0f4f-40f6-ad8b-55f34adcc19f"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4812),
                        ...
                        new
                        {
                            Id = new Guid("5a4439f4-408c-4703-9128-2bb0118677bd"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4814),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("60e0d741-0eda-4c6f-b77a-cafbe47f1579"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4816),
                        ...
                        new
                        {
                            Id = new Guid("9f65debb-7378-488d-baf2-8fad165a8c52"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4817),
                        ...
                        new
                        {
                            Id = new Guid("c72591cc-3caf-4be1-a207-ca38585b2949"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4819),
                        ...
                        new
                        {
                            Id = new Guid("45bec66e-17ad-4678-8874-ebcf7d922063"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4820),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("4ac980d0-fe3d-4362-927a-59fa0cd034ae"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4822),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("abc54980-4852-4b4e-9f3a-3d906abba7e6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 15, 42, 26, 353, DateTimeKind.Local).AddTicks(4823),
