...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220721213944_NoticeTemplateModule")]
    partial class NoticeTemplateModule
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("481f6ec5-dfb1-4eb5-b53d-e1555d360f97"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1184),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("8b877f55-b650-4295-9841-26b6d680af7c"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1202),
                        ...
                        new
                        {
                            Id = new Guid("d9f7bde5-cb1b-4c55-b7b9-1d6a5b2fb960"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1204),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("829f22a8-bbc4-4fa3-8d0e-a757762e03e0"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1205),
                        ...
                        new
                        {
                            Id = new Guid("2984fc2d-a3d7-4aba-9c26-a2bf4cc78aae"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1207),
                        ...
                        new
                        {
                            Id = new Guid("620278ac-db07-49c4-b927-4c2ccf062218"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1208),
                        ...
                        new
                        {
                            Id = new Guid("e28c65bc-0b2f-4f37-9af3-1bf5cecf199b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1222),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("175db536-d8cb-4b4a-803f-91a0dc66c9c9"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1223),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("09310706-008e-4b72-87f7-89031a113144"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 21, 18, 39, 43, 329, DateTimeKind.Local).AddTicks(1224),
