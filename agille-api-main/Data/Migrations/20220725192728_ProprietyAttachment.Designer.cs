...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220725192728_ProprietyAttachment")]
    partial class ProprietyAttachment
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c57a8b10-9b5e-488d-b467-03a6f242ada3"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8688),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("2391d9ad-6f46-4f36-99ee-89e44e30e4a1"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8702),
                        ...
                        new
                        {
                            Id = new Guid("fec614e2-6f01-419d-b70e-61c7a1aadc88"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8705),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6071e67c-8f6a-423a-bd71-e05c97861465"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8706),
                        ...
                        new
                        {
                            Id = new Guid("17eef040-18ea-4480-88eb-989337a51a7f"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8708),
                        ...
                        new
                        {
                            Id = new Guid("cfa2c322-2eef-48ad-ae5c-ad70c6261dfc"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8709),
                        ...
                        new
                        {
                            Id = new Guid("5ecfebd3-f85a-488b-a580-6d58d46f20d5"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8710),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("dd6efa41-5211-47b3-a9b3-0686244eed64"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8712),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("8ae7d947-5900-451c-afce-9d2267136efb"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 27, 26, 329, DateTimeKind.Local).AddTicks(8715),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.ProprietyAttachment", b =>
                {
                    ...
                    b.HasOne("AgilleApi.Domain.Entities.Propriety", null)
                        .WithMany("Attachments")
                        .HasForeignKey("ProprietyId1");
