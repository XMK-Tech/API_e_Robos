...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220725193443_FixProprietyCollection")]
    partial class FixProprietyCollection
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2b1dec12-f7b8-43ea-a3f9-7b72b2a23e60"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3033),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ae2672b8-60ab-46aa-b4c4-6b9e6c5ef407"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3047),
                        ...
                        new
                        {
                            Id = new Guid("e6817fa7-8429-4930-a319-c1de7f0974a0"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3049),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a4ed6ebf-c28c-4088-ba0c-369166fc3d39"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3050),
                        ...
                        new
                        {
                            Id = new Guid("7bbdb074-2e56-4e94-8664-bfdd128e445f"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3052),
                        ...
                        new
                        {
                            Id = new Guid("7c2100a3-bd7b-48a4-93ee-bb483dfffb2b"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3053),
                        ...
                        new
                        {
                            Id = new Guid("e594e0e2-a1fd-4720-913e-4eee645e0e8b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3055),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("c8ad22d4-e78f-49cb-a2d6-b7cf4520fd71"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3066),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("62213704-ff7f-4dd2-bb21-220cfcb26625"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 16, 34, 41, 553, DateTimeKind.Local).AddTicks(3068),
