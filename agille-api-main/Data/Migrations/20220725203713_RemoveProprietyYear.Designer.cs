...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220725203713_RemoveProprietyYear")]
    partial class RemoveProprietyYear
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("63ff8e94-a492-4870-b330-423f3e99aad9"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8536),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("d2b04d63-ebf8-427a-8ebc-bc36f0f35b00"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8553),
                        ...
                        new
                        {
                            Id = new Guid("a51c1de1-1a7c-4d82-866b-7cc402ab3321"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8554),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4c7ae303-47e3-4dd8-ac79-f2d4ec3f3244"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8556),
                        ...
                        new
                        {
                            Id = new Guid("e452e9e0-7c72-49f3-8625-347b1a643b81"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8557),
                        ...
                        new
                        {
                            Id = new Guid("b6c38d04-5f72-4345-856e-551cf6985de9"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8569),
                        ...
                        new
                        {
                            Id = new Guid("6f450d17-6725-43fa-90a1-a6b682b51e4d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8571),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("c52ad694-3031-4157-994d-620efc9964ff"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8572),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("af994b78-a86c-458b-ac56-467f5509bcab"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 25, 17, 37, 11, 760, DateTimeKind.Local).AddTicks(8574),
