...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220728224823_PersonDependencies")]
    partial class PersonDependencies
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b9005f3-55a6-4932-911d-cc599bc4eebd"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7693),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("bbf65317-fc52-40e1-88e0-6a047aebd7d1"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7718),
                        ...
                        new
                        {
                            Id = new Guid("550b9261-d91f-48e9-a8d7-04da5a5743bc"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7721),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("54bc77ba-8c1e-4cfc-a0e5-48f4537b2e68"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7723),
                        ...
                        new
                        {
                            Id = new Guid("13d21b29-b9d6-41cf-a197-92e09646210a"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7725),
                        ...
                        new
                        {
                            Id = new Guid("5e7bc5c6-01ca-4e7a-87b3-7ced0d2bd49d"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7728),
                        ...
                        new
                        {
                            Id = new Guid("59369562-8ec6-4d82-b5ef-24cb8f2ad166"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7730),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("86d6242f-2b96-456d-8365-976fcbdeab76"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7755),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("27ac41ec-cbfc-4499-b44e-173bfac9c1e0"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 19, 48, 22, 587, DateTimeKind.Local).AddTicks(7758),
