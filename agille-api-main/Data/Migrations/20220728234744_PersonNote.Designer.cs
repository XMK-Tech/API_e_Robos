...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220728234744_PersonNote")]
    partial class PersonNote
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("18249a06-04db-48a3-924a-b44826ec03ba"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7881),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("99b58ab2-62f7-40a0-b8cf-23c4c586a1af"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7914),
                        ...
                        new
                        {
                            Id = new Guid("fb9bbdc7-031a-4516-9730-10257f037f8a"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7916),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c73183ea-c98a-4c6f-abf2-d7d02531e89e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7917),
                        ...
                        new
                        {
                            Id = new Guid("fca938f3-6f35-43d3-b6b0-7a487e3168a8"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7918),
                        ...
                        new
                        {
                            Id = new Guid("d6322739-46af-49fb-9cfd-c3e9f8f647ce"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7920),
                        ...
                        new
                        {
                            Id = new Guid("7da2269e-46a3-4d73-b61a-e19656e9d4fe"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7921),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("611b08ec-1812-4c45-9e2c-fd4d0d3e1195"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7922),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("96ae6a50-c6ce-4b88-b814-ed7001c18dd4"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 28, 20, 47, 42, 819, DateTimeKind.Local).AddTicks(7924),
