...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220729173121_RefactPersonObs")]
    partial class RefactPersonObs
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("72b16edf-45c8-42ee-af78-f4331e3da2ec"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 946, DateTimeKind.Local).AddTicks(9974),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("bc67d427-a22f-48f7-8fd4-ac476d2a5720"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 946, DateTimeKind.Local).AddTicks(9989),
                        ...
                        new
                        {
                            Id = new Guid("85a9d4d3-e95f-457e-893e-7639f1acaa2b"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 946, DateTimeKind.Local).AddTicks(9991),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("f787fcc2-5ee9-4a15-8a00-e7e045188d3c"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 947, DateTimeKind.Local).AddTicks(65),
                        ...
                        new
                        {
                            Id = new Guid("c2df0f4b-c10d-4efa-9846-fa85b63f8c27"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 947, DateTimeKind.Local).AddTicks(76),
                        ...
                        new
                        {
                            Id = new Guid("6c37a256-c005-4035-8b40-c0d8cd55c61f"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 947, DateTimeKind.Local).AddTicks(77),
                        ...
                        new
                        {
                            Id = new Guid("01d8fe9a-f022-4266-82f0-156cbc421dfe"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 947, DateTimeKind.Local).AddTicks(80),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("4818eab3-016a-4d3e-95de-7ae8ee0cb8ea"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 947, DateTimeKind.Local).AddTicks(81),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e5cfd3c0-9bad-4314-b178-ce98f25e38c8"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 14, 31, 19, 947, DateTimeKind.Local).AddTicks(82),
