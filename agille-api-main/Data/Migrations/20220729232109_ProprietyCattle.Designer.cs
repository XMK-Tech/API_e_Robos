...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220729232109_ProprietyCattle")]
    partial class ProprietyCattle
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5ccaf6cf-8490-48bc-b55e-1d6890c95021"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5552),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("3c884b14-e24c-493a-b03f-adb35c410b9b"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5571),
                        ...
                        new
                        {
                            Id = new Guid("f301dc09-0ca1-4d29-8fba-f52a8b4c656b"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5573),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("13925444-23b6-4e8f-99a3-e5b50fd85d43"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5574),
                        ...
                        new
                        {
                            Id = new Guid("49824613-1efd-41eb-a269-82947516d470"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5576),
                        ...
                        new
                        {
                            Id = new Guid("d725e001-0841-4220-bcec-e5b0448ba131"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5586),
                        ...
                        new
                        {
                            Id = new Guid("c767c0c8-6f1d-4c88-a7dc-7df35b7c4b5b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5587),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("1105c695-98a7-477c-af8f-e12e53ed1b60"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5588),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("aef11209-8a5f-4fad-be22-7dfd98e24da9"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 7, 29, 20, 21, 7, 357, DateTimeKind.Local).AddTicks(5590),
