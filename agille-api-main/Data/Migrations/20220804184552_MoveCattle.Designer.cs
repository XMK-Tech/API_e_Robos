...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220804184552_MoveCattle")]
    partial class MoveCattle
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3ee8d2b3-d1e1-44d8-9c52-1878aca850ef"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1579),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("84c2e815-77fe-4d27-b81f-42cf02f61611"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1596),
                        ...
                        new
                        {
                            Id = new Guid("5c059f80-0053-43a6-a927-201e499d2e4c"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1598),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("df007222-0454-49ff-b51c-f342abd80d24"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1600),
                        ...
                        new
                        {
                            Id = new Guid("55206045-c835-497a-af2f-5e07f35425d2"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1601),
                        ...
                        new
                        {
                            Id = new Guid("951bb711-a409-4aab-a68b-1a92d4fb4e40"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1603),
                        ...
                        new
                        {
                            Id = new Guid("14131fb6-8354-4452-bd56-5a2ac3353e5f"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1615),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("77d58104-d412-4d84-bffa-3d9e394130c7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1616),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("57de6c63-79e5-458f-be88-6c8a15877a7a"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 4, 15, 45, 51, 117, DateTimeKind.Local).AddTicks(1617),
