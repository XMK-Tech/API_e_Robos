...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220805191804_Checklist")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("29838791-660f-4221-900c-aedcce02f85f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4943),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("d8a272b2-c635-4ec4-ac3b-aa52c080e839"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4957),
                        ...
                        new
                        {
                            Id = new Guid("615b37a4-c64e-49d5-92ba-c9213fb7dd16"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4968),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("3f414d6e-2f1f-47be-ae24-e56439a3f466"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4969),
                        ...
                        new
                        {
                            Id = new Guid("bf59da97-12a9-440f-b4b6-3756c18cb815"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4971),
                        ...
                        new
                        {
                            Id = new Guid("37b40fa7-631e-4736-9d31-1a15b4af36b3"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4972),
                        ...
                        new
                        {
                            Id = new Guid("12316408-e78a-484c-90bc-9bbb2ea11239"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4974),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("21c1f132-e76e-4660-a86c-a32a3e6589ff"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4975),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("fd7d2869-e1c5-4cd7-9880-97f98e3ec3f4"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 5, 16, 18, 2, 944, DateTimeKind.Local).AddTicks(4977),
