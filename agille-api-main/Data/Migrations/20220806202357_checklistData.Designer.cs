...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220806202357_checklistData")]
    partial class checklistData
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("60c7df1c-ec1c-4dcf-845f-c9c414a9fef2"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1925),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("bcf84939-34a2-4817-9024-bdc12d3bcae3"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1937),
                        ...
                        new
                        {
                            Id = new Guid("d72901b1-afa6-4d53-9279-5a976a052883"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1939),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e13f9af5-b3aa-4847-8ac7-79225be16712"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1941),
                        ...
                        new
                        {
                            Id = new Guid("143b94dd-acfc-4dec-a236-bcd1d34fe8ee"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1948),
                        ...
                        new
                        {
                            Id = new Guid("59290a49-2ecb-4b4f-95ec-17f9e9b3a3c1"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1950),
                        ...
                        new
                        {
                            Id = new Guid("79ced473-8f22-429e-98c4-a689d050ad0d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1951),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("61f99c87-3c51-4b45-9c63-34292585116e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1952),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("41fd0fb8-a375-4dec-89d1-10701e9a5189"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 6, 17, 23, 56, 184, DateTimeKind.Local).AddTicks(1954),
