...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220808222840_NotificationBody")]
    partial class NotificationBody
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7dd449cb-a05c-4e27-85b7-5dc040464afb"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8125),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("10b97002-ec73-4152-95b9-c0d5c7fe851f"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8143),
                        ...
                        new
                        {
                            Id = new Guid("c0fc7564-4ded-42d1-877f-3e66ebbe8cbb"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8146),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("66f8c2e0-ee45-4e81-bd79-cad8a08e1164"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8147),
                        ...
                        new
                        {
                            Id = new Guid("4b902496-b1eb-4182-923b-256afdb019c8"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8148),
                        ...
                        new
                        {
                            Id = new Guid("e9a42df9-00e4-403d-954c-d16899e7ddb1"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8169),
                        ...
                        new
                        {
                            Id = new Guid("75338ca0-3367-4fed-a83b-3a78f3b1aaa5"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8170),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("2042f80c-b05b-416b-93da-e0e5f9c13ba5"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8172),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("adb9f055-fcfd-4c6e-85d7-f9c44b2a90b6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 8, 19, 28, 38, 445, DateTimeKind.Local).AddTicks(8173),
