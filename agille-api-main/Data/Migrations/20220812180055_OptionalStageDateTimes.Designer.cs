...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220812180055_OptionalStageDateTimes")]
    partial class OptionalStageDateTimes
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f1d73817-f1b8-4d0f-be20-87560aa92b78"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8719),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("99acc777-c883-4b47-a552-9544ddc984e4"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8733),
                        ...
                        new
                        {
                            Id = new Guid("66bfe7ce-b124-42c3-96ab-ad8ecae8fb45"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8734),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a7b969c2-5a8a-4639-8cc0-f7c559079990"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8736),
                        ...
                        new
                        {
                            Id = new Guid("198bd2bb-36dc-47dd-8ce8-9de94642c58b"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8737),
                        ...
                        new
                        {
                            Id = new Guid("738aca8a-3735-4372-b0b2-99ffc4ff147b"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8739),
                        ...
                        new
                        {
                            Id = new Guid("0c80ee6c-8d9b-4c11-ae99-a43351fda201"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8752),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("425f413a-747e-492f-8722-c3840aae75c9"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8753),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e6bef4bd-5330-4ed0-986d-b6ef59797b67"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 15, 0, 53, 918, DateTimeKind.Local).AddTicks(8755),
