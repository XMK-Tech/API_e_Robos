...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220812194738_TaxStageNullableData")]
    partial class TaxStageNullableData
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2d017004-ba30-4ce8-abf1-5b744c5202ab"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4105),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("98493dfe-ae69-472f-bede-45fae76b32ee"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4161),
                        ...
                        new
                        {
                            Id = new Guid("b6d00756-25f2-4d7b-8e48-d8ae0e9fff55"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4257),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("03c601d3-5014-4ec5-ac54-2537039b2eb7"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4259),
                        ...
                        new
                        {
                            Id = new Guid("b56d34fb-9b41-4c16-9328-18991563e4eb"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4261),
                        ...
                        new
                        {
                            Id = new Guid("4878cd9b-581e-46ae-9fbb-49419b22f6f3"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4262),
                        ...
                        new
                        {
                            Id = new Guid("5bcb71d9-f7ae-41a4-b0dd-a3e087ff0eac"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4263),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("f6769e24-40a7-42f0-899e-4da5ff36a2ee"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4265),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4c0f8dad-5367-456a-9e10-5d80a504b1d2"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 16, 47, 36, 292, DateTimeKind.Local).AddTicks(4275),
