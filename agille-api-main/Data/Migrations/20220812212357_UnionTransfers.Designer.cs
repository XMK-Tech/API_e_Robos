...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220812212357_UnionTransfers")]
    partial class UnionTransfers
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("402203eb-e792-45e2-bd4d-dfcf14456fa8"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9765),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("75028aa5-f6f4-40a6-9ca3-9eb9ecbb688b"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9781),
                        ...
                        new
                        {
                            Id = new Guid("08834730-a7e6-4da8-884b-7054d26213d2"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9783),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6ae7ec50-cc26-4ab2-a70e-afab8f21515b"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9785),
                        ...
                        new
                        {
                            Id = new Guid("9ad6aa71-6cfb-4cd9-8829-083e2a472775"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9786),
                        ...
                        new
                        {
                            Id = new Guid("db78b660-ecc9-4e1d-9d0a-bac6d22e003c"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9787),
                        ...
                        new
                        {
                            Id = new Guid("439041d4-25e1-4078-9508-8e2e660a0284"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9816),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("321449fb-d690-4530-b1ab-3983ef0cf7d5"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9818),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a7f34f60-fdee-4983-a170-d5e70bd932fc"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 12, 18, 23, 55, 630, DateTimeKind.Local).AddTicks(9819),
