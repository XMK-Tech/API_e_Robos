...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220815184346_ChecklistAttachments")]
    partial class ChecklistAttachments
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d255b231-533e-41c9-89b8-6e4a10b76159"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(2954),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("aaf691d3-dad7-427b-97c8-0fe64f50ae94"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(2989),
                        ...
                        new
                        {
                            Id = new Guid("2dcebba4-cc0d-44b6-b1c0-682ca15cb314"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(2993),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("312dc115-6c19-487e-af0f-8fa27971a69a"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(2994),
                        ...
                        new
                        {
                            Id = new Guid("1a6ba89d-d3b2-430c-a231-0460619f3b48"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(2996),
                        ...
                        new
                        {
                            Id = new Guid("2b6ed129-c85c-42e8-b655-9743ba070ef3"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(3006),
                        ...
                        new
                        {
                            Id = new Guid("8945c094-4df0-4b43-a24d-0277243b8a00"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(3008),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("391859db-2dbc-47aa-ab36-e93299b4248a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(3010),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b0455493-42f5-46e2-b1fb-8f3026f607fa"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 15, 43, 43, 915, DateTimeKind.Local).AddTicks(3011),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.ChecklistAttachment", b =>
                {
                    ...
                    b.HasOne("AgilleApi.Domain.Entities.Checklist", null)
