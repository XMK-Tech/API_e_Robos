...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220815190447_FixChecklistAttachment")]
    partial class FixChecklistAttachment
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c12d494-eab2-4517-ada5-031c2660152e"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7228),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("c8585c34-750e-4a34-8acf-0e8b215dd1e9"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7242),
                        ...
                        new
                        {
                            Id = new Guid("0b936859-e3cf-4776-9179-65fc64452c39"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7244),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("59601d07-2193-4b76-bb62-9b8d8c591957"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7245),
                        ...
                        new
                        {
                            Id = new Guid("b82f94be-375c-4ec0-bba8-10ccad2235ef"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7247),
                        ...
                        new
                        {
                            Id = new Guid("a3fa8ca8-5765-4c5a-9958-cb079bcfd20b"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7248),
                        ...
                        new
                        {
                            Id = new Guid("3ee996d1-bddf-4e7a-a4e9-8593652509d7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7249),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("b4efdecf-623b-4b4b-b115-0d122e869f11"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7251),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c8c7fd40-bcf2-4193-a0a1-9a60c766de58"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 16, 4, 45, 708, DateTimeKind.Local).AddTicks(7254),
