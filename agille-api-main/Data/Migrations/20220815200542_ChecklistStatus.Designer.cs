...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220815200542_ChecklistStatus")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e244633e-687e-4e8c-9087-50068a03a43f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(825),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("968b0358-c863-40b0-ad46-0e4e96dff995"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(841),
                        ...
                        new
                        {
                            Id = new Guid("76dd079d-dc1f-426c-a3a3-4b71a53f834c"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(853),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("58d779e1-6fcd-4653-838f-56810a02bd0a"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(854),
                        ...
                        new
                        {
                            Id = new Guid("2932c19f-54a1-477b-b03f-ab65a5080cdd"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(856),
                        ...
                        new
                        {
                            Id = new Guid("deb417be-81b1-47c8-8da5-5de9394cc154"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(900),
                        ...
                        new
                        {
                            Id = new Guid("03d77956-4cfd-41e1-8f02-9901ad78faef"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(902),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("36101509-66da-4ad0-a046-1a500eebe72c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(904),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b1b7f7ea-e4f4-4287-8509-c3b083218af3"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 15, 17, 5, 40, 544, DateTimeKind.Local).AddTicks(905),
