...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220816174827_Audit")]
    partial class Audit
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f5a6a813-d255-420e-954d-d8bbe7f29fd8"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6839),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("9f76c441-33e9-43b4-96d3-ec3423a98267"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6855),
                        ...
                        new
                        {
                            Id = new Guid("2389d992-0290-4f57-a989-830d3f1edd88"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6856),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("aeaafaa3-c795-4ac8-8d7e-8fe52c7c7575"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6858),
                        ...
                        new
                        {
                            Id = new Guid("94531aec-a166-452b-b2d9-6b26f165c34f"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6859),
                        ...
                        new
                        {
                            Id = new Guid("265ee242-ffb7-4687-a0a6-9ba923e64178"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6861),
                        ...
                        new
                        {
                            Id = new Guid("e0a2f35c-e708-4bf1-a474-ab6a72d70e55"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6876),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("a22032ad-84ac-48f5-85e6-89114aa606e8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6878),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1dd6f07c-5cd8-43b1-980d-276d3a2de96f"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 14, 48, 24, 993, DateTimeKind.Local).AddTicks(6879),
