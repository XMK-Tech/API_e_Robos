...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220816230047_RemoveUnUsedTemplates")]
    partial class RemoveUnUsedTemplates
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f22cf825-3bee-4654-93cd-59a2fddcb01e"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1868),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("8b312ea5-c110-4475-bfc2-7acec9090ca0"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1882),
                        ...
                        new
                        {
                            Id = new Guid("b087a63d-ed69-4656-a760-3220886714f9"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1884),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("834efa19-1273-481a-9646-cc5d75891051"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1885),
                        ...
                        new
                        {
                            Id = new Guid("6f33ddf3-5f11-4f53-91ac-726c7287af40"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1887),
                        ...
                        new
                        {
                            Id = new Guid("04322a82-ad5d-4439-81e1-4e14dc45fb5f"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1899),
                        ...
                        new
                        {
                            Id = new Guid("c46b6f44-bb0b-4ad4-ae73-4daf52316dab"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1900),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("45d42c1d-3082-4306-ad5e-ef5a00627eea"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1901),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("fa183c44-f738-4a6a-b3f8-9ae2d3b4bc3e"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 16, 20, 0, 44, 570, DateTimeKind.Local).AddTicks(1903),
