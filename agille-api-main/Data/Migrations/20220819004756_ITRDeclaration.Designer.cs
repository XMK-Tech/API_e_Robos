...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220819004756_ITRDeclaration")]
    partial class ITRDeclaration
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("90c1d470-19e1-48c5-a997-b24d387cacfb"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(689),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("f8d03850-4d3b-4919-b841-7744ebf7df1e"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(703),
                        ...
                        new
                        {
                            Id = new Guid("ae921059-1a81-4442-8936-4fd48965fce6"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(705),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4055ed78-b76f-4463-b223-bc6639311e89"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(706),
                        ...
                        new
                        {
                            Id = new Guid("4e3e942e-6391-4e06-97b1-ff3a5f25bbed"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(707),
                        ...
                        new
                        {
                            Id = new Guid("7bc0cb80-e6f7-428d-8b9b-d483271ab011"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(709),
                        ...
                        new
                        {
                            Id = new Guid("5136f9a3-ccc3-41be-a608-129d06ed9b53"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(710),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("8a1a4d6b-b4cc-40e2-923c-6f08b710f84c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(712),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("3901a2a1-60cf-4eac-b696-9f94c968cc23"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 18, 21, 47, 52, 489, DateTimeKind.Local).AddTicks(715),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.TaxPayerDeclaration", b =>
                {
                    ...
                    b.Property<decimal>("EnvironmentalPreservation")
                        .HasColumnType("decimal(18,2)");
