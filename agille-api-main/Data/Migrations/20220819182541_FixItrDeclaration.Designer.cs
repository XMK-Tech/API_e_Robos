...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220819182541_FixItrDeclaration")]
    partial class FixItrDeclaration
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("36186670-2ea7-42b1-9787-8dec4c642a7c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1335),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("4f2f0b53-2d62-4206-aa68-0803a512bf5c"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1354),
                        ...
                        new
                        {
                            Id = new Guid("13f30d07-5a50-49ef-8d30-60817942b61f"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1358),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("23bcfc03-e6a8-4f0e-92c7-21de9bf97f2d"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1362),
                        ...
                        new
                        {
                            Id = new Guid("8cc92510-521b-4c55-beb8-6ed90361cae2"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1364),
                        ...
                        new
                        {
                            Id = new Guid("11a4536f-3a4e-4ab8-8fa7-646c61fb7747"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1369),
                        ...
                        new
                        {
                            Id = new Guid("b932caed-0124-45a3-8293-33d94f90d44e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1371),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("379a2d86-2971-4d35-b2dc-5423f53441c7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1374),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("0f047949-61da-4091-aaa7-455c9b5d2080"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 19, 15, 25, 37, 773, DateTimeKind.Local).AddTicks(1381),
