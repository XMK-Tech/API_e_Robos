...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220822231604_CreatePersonUser")]
    partial class CreatePersonUser
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("343058eb-5405-4940-9eb5-7fa140ff16cb"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(471),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("fa3951e3-1e52-44f8-8e35-a4c3dcf5d51e"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(486),
                        ...
                        new
                        {
                            Id = new Guid("cb3ea827-2915-4b03-a06e-0e01d72e9516"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(488),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("56d95578-7e8e-41e8-9caf-ba0b6143bc42"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(489),
                        ...
                        new
                        {
                            Id = new Guid("06fe18ab-7fa9-4a92-a349-678f246a2ac0"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(491),
                        ...
                        new
                        {
                            Id = new Guid("af8c211c-9580-4804-b9ed-b34d340756f1"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(492),
                        ...
                        new
                        {
                            Id = new Guid("8e5a04b1-8e35-48a0-be8b-b96d2b5216bb"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(494),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("6c92a48d-0a36-4ff3-9b27-e7901f5d3ff6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(506),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ac45b460-73e5-4672-af7c-1656bc7dc4d4"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 22, 20, 16, 1, 257, DateTimeKind.Local).AddTicks(507),
