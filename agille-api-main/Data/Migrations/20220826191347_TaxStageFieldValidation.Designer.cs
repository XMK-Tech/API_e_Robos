...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220826191347_TaxStageFieldValidation")]
    partial class TaxStageFieldValidation
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("12fb56a7-172c-4f9d-95bb-ba002f739e26"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6080),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("eb763c8c-354d-48c6-a0fc-aaab6c4f282b"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6096),
                        ...
                        new
                        {
                            Id = new Guid("864067ba-9724-415c-8506-c35ada3dcaa4"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6097),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("86eb2fca-14d5-4b48-babf-0ef0eb2e51d6"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6099),
                        ...
                        new
                        {
                            Id = new Guid("6f9702b0-2aa4-46c3-ab5f-397b56dbc148"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6100),
                        ...
                        new
                        {
                            Id = new Guid("e2335678-9ee9-4287-b640-b6fe048f24d3"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6102),
                        ...
                        new
                        {
                            Id = new Guid("a1d48260-953b-46ed-a018-e5d18e4d14f7"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6103),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("6b735632-42ba-4f63-87c1-ef1517e372ef"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6104),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4f353758-3d4f-48ce-aa1d-19145f7467ff"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 26, 16, 13, 43, 924, DateTimeKind.Local).AddTicks(6108),
