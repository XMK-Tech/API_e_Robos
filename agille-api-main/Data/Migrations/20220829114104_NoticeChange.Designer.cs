...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220829114104_NoticeChange")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ebcacb20-dd0f-4fe2-bb47-b995c141ef42"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1870),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("cf4f8a62-70b5-4596-bea2-92d6d1ea31e3"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1889),
                        ...
                        new
                        {
                            Id = new Guid("b2cdb016-90da-41f3-aca9-ba9bf5017a7d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1909),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("bc309e39-aca5-47aa-af29-860fcd036848"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1914),
                        ...
                        new
                        {
                            Id = new Guid("0dab71f0-4bf8-456c-9b2f-cbf51226f975"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1919),
                        ...
                        new
                        {
                            Id = new Guid("ac349223-75df-4dc5-86e9-c19d2e94de36"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1923),
                        ...
                        new
                        {
                            Id = new Guid("aa9a163d-dd3e-4779-aa3c-db9758b26b20"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1928),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("79deb3db-60fd-497f-996b-2b3200f9ec37"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1932),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("5c83d743-9f5b-4264-be41-508bbfe218d8"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 8, 29, 8, 41, 0, 709, DateTimeKind.Local).AddTicks(1937),
