...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220906122354_ManualNotice")]
    partial class ManualNotice
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0cf10300-9613-44cf-bada-32ae281d83c4"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1410),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("9e43e106-6d88-4352-bf30-b3414a10148b"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1430),
                        ...
                        new
                        {
                            Id = new Guid("e8e99ee6-18df-451e-9531-a3881c1973b6"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1432),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b8058415-55d2-4a94-abe2-bae08d7af6e1"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1433),
                        ...
                        new
                        {
                            Id = new Guid("d518917a-5457-49bd-b68e-60b5ae2e2a7d"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1436),
                        ...
                        new
                        {
                            Id = new Guid("6e33435e-143e-4a48-bd47-1cf516d9f52d"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1438),
                        ...
                        new
                        {
                            Id = new Guid("a18f9177-fac5-4601-ac58-670433db4a2a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1439),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("87a06128-084c-40ad-bc04-48d5ea745ee0"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1440),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("13288bb3-6337-45e1-ac79-cfbca5c36318"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 6, 9, 23, 50, 940, DateTimeKind.Local).AddTicks(1444),
