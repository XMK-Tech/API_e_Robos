...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220907112135_NoticeTemplates")]
    partial class NoticeTemplates
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d5b9155b-87ef-4e29-81d4-2814dc834a1b"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4576),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("712d22fd-cebc-46ed-b316-3546b4580fd7"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4593),
                        ...
                        new
                        {
                            Id = new Guid("70beebaf-eab5-4cc0-ac0c-d5be05178801"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4595),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e6252d00-3bdd-47a2-9c07-57526b7107aa"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4596),
                        ...
                        new
                        {
                            Id = new Guid("32a5c7a0-6a72-4b2c-aaaa-efedc6637fff"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4598),
                        ...
                        new
                        {
                            Id = new Guid("6f59c359-efe4-415e-9cda-ff56751b4f7b"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4599),
                        ...
                        new
                        {
                            Id = new Guid("f6727bd8-78fe-4d6b-aece-a527bd0bc6fa"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4601),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("571a00eb-63d5-49e1-a3a4-a5927c9f4c36"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4602),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("61660b65-f315-4e49-9d2b-a39cc9f7e98d"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 8, 21, 31, 766, DateTimeKind.Local).AddTicks(4606),
