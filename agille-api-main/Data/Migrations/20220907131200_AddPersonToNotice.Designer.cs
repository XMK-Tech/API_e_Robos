...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220907131200_AddPersonToNotice")]
    partial class AddPersonToNotice
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7a0cf8e8-5e0d-476b-963f-a9163d223440"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1779),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("58c454b8-5e03-43fa-b260-6402658a8bba"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1792),
                        ...
                        new
                        {
                            Id = new Guid("57f7fbc8-38bf-4f38-8449-a7181a121101"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1794),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("61178eba-e855-45ed-8dcd-881e46a2f079"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1795),
                        ...
                        new
                        {
                            Id = new Guid("52e05932-32bd-49c6-818a-c7c199228ec6"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1796),
                        ...
                        new
                        {
                            Id = new Guid("d31dd21d-f4e7-4234-83ef-0d6c098a457d"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1798),
                        ...
                        new
                        {
                            Id = new Guid("aba36399-0155-4bff-a55a-84ead4cc1457"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1805),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("5c59a74f-5664-43eb-87a0-5ce7f46e234b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1807),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c509d305-da11-4a79-9bf1-0285d9f28d4c"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 7, 10, 11, 57, 572, DateTimeKind.Local).AddTicks(1808),
