...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220916102224_TaxStageReply")]
    partial class TaxStageReply
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1224cc0-ade0-4608-93da-ba6924d3c47a"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1371),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("9561741b-b52d-4216-aa74-4a00f8dfd1e4"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1386),
                        ...
                        new
                        {
                            Id = new Guid("97a6d8fa-3246-4f24-a43f-57e022795c89"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1388),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("435035a2-73de-4255-b6b3-8bcb3fc4bcdf"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1389),
                        ...
                        new
                        {
                            Id = new Guid("9aa6f570-db56-46ae-8324-0820a243f762"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1391),
                        ...
                        new
                        {
                            Id = new Guid("2fad427b-e4e7-4af6-9211-8572f46534cc"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1392),
                        ...
                        new
                        {
                            Id = new Guid("a9b00d04-4f8d-437a-b2e8-c0bdda74b34b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1404),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("8208271b-3dfa-445d-b773-9b2815f7555b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1405),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("bd571e2e-f064-4608-8b34-8fed14764bc4"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 7, 22, 21, 12, DateTimeKind.Local).AddTicks(1406),
