...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220916230425_ChangeCardDivergencyEntry")]
    partial class ChangeCardDivergencyEntry
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("421af626-770f-4b34-afd6-5a345442ec21"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3490),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("38a6d26a-7eda-4a4b-9fe1-fdeae1b9e32c"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3508),
                        ...
                        new
                        {
                            Id = new Guid("da6723b9-7d47-4e7f-93ce-00c9ae624aaf"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3510),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("5946d7c1-5e6b-4277-92c0-59dd221741c8"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3512),
                        ...
                        new
                        {
                            Id = new Guid("8bfb5a6a-575d-4bc4-8020-0db2906b2d9e"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3513),
                        ...
                        new
                        {
                            Id = new Guid("d819badb-a531-433b-bca9-841a35627bc3"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3514),
                        ...
                        new
                        {
                            Id = new Guid("242c6181-40b6-476f-850a-e6c41cabc68b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3522),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("a1018416-c676-4b9d-9e6d-6c5e2a9bcd50"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3523),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("9bc135c8-5ecd-4f50-8447-5bc7a17347be"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 16, 20, 4, 22, 231, DateTimeKind.Local).AddTicks(3525),
