...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220919142301_TaxPayerDeclarationImport")]
    partial class TaxPayerDeclarationImport
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5aef41a4-511a-4ec5-96ba-bb96b76b40b5"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7438),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("dbd9e70b-335b-4d8f-ad60-934fa2a1fd87"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7461),
                        ...
                        new
                        {
                            Id = new Guid("c9d4b53a-11e9-43df-b66d-0cae8223c83f"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7463),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("2b283bfa-79b6-458f-98e8-f7565aa147b6"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7484),
                        ...
                        new
                        {
                            Id = new Guid("169048b3-c4de-42c0-9571-8d0aa697a224"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7486),
                        ...
                        new
                        {
                            Id = new Guid("46a43d5a-855f-4fed-b607-b79454a6c39b"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7487),
                        ...
                        new
                        {
                            Id = new Guid("e5b683fc-580d-4b84-812d-fb1a41ed9667"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7489),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("cfaa196a-7034-4eda-9460-69218ac4a428"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7490),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ef63922f-c698-47e8-b3f4-7b31b78fe664"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 19, 11, 22, 58, 280, DateTimeKind.Local).AddTicks(7491),
