...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220923120342_DeclarationPerson")]
    partial class DeclarationPerson
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("509e493e-d416-4972-8280-e723c1454056"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5124),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("5d7df43a-94cb-48dc-af4c-896bf29ee6ea"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5138),
                        ...
                        new
                        {
                            Id = new Guid("94a75b4c-4a77-43e5-b54b-6fcd95a4214a"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5140),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("8e80056a-8c6e-46ad-aee2-76f94903e629"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5141),
                        ...
                        new
                        {
                            Id = new Guid("f7b49139-6e35-45bb-b764-d8e8fc0c3074"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5143),
                        ...
                        new
                        {
                            Id = new Guid("6dd283fd-a506-452d-b6b0-a5895cd801a8"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5144),
                        ...
                        new
                        {
                            Id = new Guid("565772fa-3ad4-44fa-b8ba-6ae27e596f1f"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5155),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("a13f99e7-48aa-441d-bfd2-2d39f05c7694"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5157),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("51f429b6-1ab7-4ad7-b9ef-65783bef2c87"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 9, 3, 39, 675, DateTimeKind.Local).AddTicks(5158),
