...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220923181044_DeclarationRequiredFix")]
    partial class DeclarationRequiredFix
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d35094e3-2f07-406d-a303-c7ae0fe08e57"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1817),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ab6b2ea6-8259-47ce-bb60-1ae0b64cdd1d"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1836),
                        ...
                        new
                        {
                            Id = new Guid("e416a0c4-a5c5-4e98-a20a-538ff4b3c045"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1838),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c5a7a5c0-1c0b-4576-8a7c-2c15b264248e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1840),
                        ...
                        new
                        {
                            Id = new Guid("b1891c52-d835-4bbe-9a83-0f7bacc98df7"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1841),
                        ...
                        new
                        {
                            Id = new Guid("dac506e7-0b1b-47a7-bff0-603f7f64150f"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1842),
                        ...
                        new
                        {
                            Id = new Guid("50a89126-5a42-4a3b-8de9-f7197f1db4dd"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1845),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("21e73a58-2526-4b36-8195-a353bc7d972e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1846),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("734adbf8-3af1-477f-b6e4-697c6e24cdfd"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 23, 15, 10, 41, 490, DateTimeKind.Local).AddTicks(1850),
