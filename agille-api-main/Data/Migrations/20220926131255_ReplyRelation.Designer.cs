...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220926131255_ReplyRelation")]
    partial class ReplyRelation
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ff6e3847-4af5-40dd-8540-9b39902afa85"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8289),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("e29cfe15-014b-4e89-b9dc-3ba9d9239138"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8306),
                        ...
                        new
                        {
                            Id = new Guid("5ed63e0d-f441-47c8-a784-7dcf78e0a947"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8307),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b3e6358f-e84c-4bab-80d5-56dea38b4567"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8309),
                        ...
                        new
                        {
                            Id = new Guid("6a97f390-315e-4056-baf1-16144e97bb5f"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8310),
                        ...
                        new
                        {
                            Id = new Guid("5419244e-9cd0-4e56-812f-cf4e3f50f494"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8312),
                        ...
                        new
                        {
                            Id = new Guid("7471dc47-18f1-4757-ab4b-2a6bf4da066c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8325),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("cf5d00c4-e332-4e15-a4a1-7362f0bb43bd"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8327),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("f91b14da-6cf1-44c5-a590-3538bf121d80"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 26, 10, 12, 51, 645, DateTimeKind.Local).AddTicks(8328),
