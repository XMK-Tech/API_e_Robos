...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20220929000656_TaxActionAttachment")]
    partial class TaxActionAttachment
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4ba4a7c5-df39-4734-994f-ec0619f1fe2c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5454),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("aace6f25-2507-4cb3-b20f-38131520ea7d"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5470),
                        ...
                        new
                        {
                            Id = new Guid("8e37107b-3a64-439b-81ae-a19ba558a7f5"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5471),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("87a61d86-6873-4244-8abd-14bd78dce6c6"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5473),
                        ...
                        new
                        {
                            Id = new Guid("334f802b-1786-4c13-a608-3d8784d1b4bc"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5474),
                        ...
                        new
                        {
                            Id = new Guid("a0bb4b5f-aca0-4d4a-9fc6-5395fd8fc56b"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5476),
                        ...
                        new
                        {
                            Id = new Guid("489e477d-290e-4f77-8daf-43c53e306145"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5477),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("a05146ef-8cbe-400f-9dee-4dc8476c9479"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5485),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("13d0700c-9277-4e87-96f6-e18ad4e8f1a6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 9, 28, 21, 6, 53, 754, DateTimeKind.Local).AddTicks(5486),
