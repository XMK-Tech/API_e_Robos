...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20221003134249_BaseEntryValidation")]
    partial class BaseEntryValidation
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b3d1db5c-0c7c-44f3-bf58-262a199304f5"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4146),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("93c6d3b9-f2a9-4f31-bc8c-1926c0f062bd"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4162),
                        ...
                        new
                        {
                            Id = new Guid("b2d2a184-03b4-4635-859f-333a823203e2"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4163),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("52139313-3682-49f4-ba2e-51cc606c3d6e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4165),
                        ...
                        new
                        {
                            Id = new Guid("b87816ba-9488-4c1f-8e57-8b55d57f467d"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4166),
                        ...
                        new
                        {
                            Id = new Guid("3c5b1b65-5325-4931-8b39-2c919453664e"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4168),
                        ...
                        new
                        {
                            Id = new Guid("6c09f13c-92ee-4498-91b4-6e22bef17f93"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4175),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("bca93db8-b5b0-4989-b261-db29aaf1b3d0"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4177),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("25c9a96f-36ab-4cdb-afd4-bfafdb829a6a"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 3, 10, 42, 45, 564, DateTimeKind.Local).AddTicks(4178),
