...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20221005122929_DivergenciesInvalidation")]
    partial class DivergenciesInvalidation
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("436e7fd3-bfc3-467b-b52d-df21b57c2e69"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5671),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a28acf64-66bd-4e9e-80bd-6a0bcf43573c"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5682),
                        ...
                        new
                        {
                            Id = new Guid("44fd37fb-e3e9-44b5-b3e8-5dd0335e8d23"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5684),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1f20c7fd-7eb4-4802-985d-d4cef4ff63a5"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5685),
                        ...
                        new
                        {
                            Id = new Guid("357ce5da-9381-44d1-9fe4-fc69387605e8"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5687),
                        ...
                        new
                        {
                            Id = new Guid("20e0906e-fbeb-43a4-8875-b768e0edc6b8"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5688),
                        ...
                        new
                        {
                            Id = new Guid("d4fc4833-1e04-44a9-8ecf-a0d5e41a31f8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5701),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("cf46f77a-4d2c-4da7-88cf-88025239b1e5"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5703),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("dc19839d-b637-4b02-bd2c-50dcb7698d84"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2022, 10, 5, 9, 29, 25, 915, DateTimeKind.Local).AddTicks(5704),
