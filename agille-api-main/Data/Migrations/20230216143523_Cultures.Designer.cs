...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230216143523_Cultures")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bafa4311-a990-4270-ac00-3f635677148c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(3995),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("c23a9698-d528-4a63-a825-dbac504932ba"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4006),
                        ...
                        new
                        {
                            Id = new Guid("f3d93283-46d9-4df8-a9cb-13eea0ffde01"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4008),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("92cf4db1-9409-4ee9-a9c5-377d6d98ddbe"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4009),
                        ...
                        new
                        {
                            Id = new Guid("c702a1f6-7dbb-4eda-bd59-17b0bca89a4c"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4018),
                        ...
                        new
                        {
                            Id = new Guid("9802ce9b-f056-4dec-9655-3f8d22cb70fe"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4019),
                        ...
                        new
                        {
                            Id = new Guid("9603bd8c-357c-4e95-819d-73674df2cd6e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4020),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("30738efa-29f4-4f9b-8cc2-4609dfebb305"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4022),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("16eb8929-1143-4db2-bf7b-ea57c2902965"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 16, 11, 35, 22, 545, DateTimeKind.Local).AddTicks(4023),
