...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230217130212_DefaultCultures")]
    partial class DefaultCultures
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("94837fd7-8b95-44e8-ade8-b4d0dac22940"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4642),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("72e11880-0643-43c0-b12d-96b6efe269c3"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4656),
                        ...
                        new
                        {
                            Id = new Guid("80112870-25ed-46ab-afa8-5f79995dcc00"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4658),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("fe86926b-70d8-421e-83fc-277babf41575"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4659),
                        ...
                        new
                        {
                            Id = new Guid("6866b8d3-d15b-4a24-a457-205ca77d2288"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4661),
                        ...
                        new
                        {
                            Id = new Guid("d5a50b1f-cd11-48e1-958f-814339a6005c"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4663),
                        ...
                        new
                        {
                            Id = new Guid("482d4e2e-c870-40ab-b093-0e1e26f04de4"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4670),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("0842bb79-a913-4b88-a35e-ba0e53846e26"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4672),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b273cdbb-6087-4bec-b3c8-819da2040e04"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 17, 10, 2, 8, 478, DateTimeKind.Local).AddTicks(4673),
