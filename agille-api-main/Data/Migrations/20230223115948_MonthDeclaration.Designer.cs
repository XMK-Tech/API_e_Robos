...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230223115948_MonthDeclaration")]
    partial class MonthDeclaration
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1274b3bd-fc21-442c-8ed8-38c0218db0cc"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6257),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("43ab97c4-bf31-4a88-ad56-6f2a5d7a12a0"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6271),
                        ...
                        new
                        {
                            Id = new Guid("a806fcb7-0605-443a-99f1-5a776c1932de"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6273),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("5d34a5bc-e4aa-4994-b2cf-99c6b5eb760f"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6274),
                        ...
                        new
                        {
                            Id = new Guid("73b4acfb-c370-447b-9361-18fd131405ec"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6276),
                        ...
                        new
                        {
                            Id = new Guid("bb83f6b7-bca3-4f3b-a753-5873de931111"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6277),
                        ...
                        new
                        {
                            Id = new Guid("de7962e9-5b2f-466b-ad9e-d62a4eaadf9a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6288),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("7fcc1f28-8869-4de6-af09-f25a9460f149"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6289),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("6d6e2f0a-cf6e-4c6d-b674-a3c792c197d9"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 8, 59, 46, 616, DateTimeKind.Local).AddTicks(6291),
