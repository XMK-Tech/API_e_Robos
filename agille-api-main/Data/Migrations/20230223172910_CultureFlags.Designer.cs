...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230223172910_CultureFlags")]
    partial class CultureFlags
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b37c91d0-ecf4-4d9a-9aca-bbd382813157"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3777),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("cc1a6aec-80c3-48ce-a3a8-523c28104005"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3792),
                        ...
                        new
                        {
                            Id = new Guid("0fe4171f-c2a8-455c-a742-0fd340326690"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3794),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c40655f8-1f96-4585-bf96-b7e758afcb2e"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3795),
                        ...
                        new
                        {
                            Id = new Guid("aff4c4ce-0ecf-4f48-a062-4b63141300c3"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3797),
                        ...
                        new
                        {
                            Id = new Guid("d50c1d8d-1e91-477c-b592-fb9b38f5a498"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3798),
                        ...
                        new
                        {
                            Id = new Guid("1e19886a-8223-4c1f-9eec-90455e379ed6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3811),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("cd05a966-6ebd-490a-afda-79b0d7abd49e"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3812),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("8eba0dc5-67dd-4779-9a38-f13e53047950"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 2, 23, 14, 29, 6, 878, DateTimeKind.Local).AddTicks(3814),
