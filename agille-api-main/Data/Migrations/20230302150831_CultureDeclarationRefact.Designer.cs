...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230302150831_CultureDeclarationRefact")]
    partial class CultureDeclarationRefact
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("08257c12-0dd2-4a49-848f-84f267aa9ddd"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1275),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("aedbe384-0001-49de-aabc-fc28af8a7381"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1288),
                        ...
                        new
                        {
                            Id = new Guid("c0f9af12-35fa-4f1a-9d2a-44b789c925ad"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1290),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4713d68d-e174-421a-9b30-8076aa94d661"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1291),
                        ...
                        new
                        {
                            Id = new Guid("120c7eb6-b67c-4778-a2da-7a547719e5a9"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1292),
                        ...
                        new
                        {
                            Id = new Guid("c9ddf02b-47cb-45b3-b65d-f537db146266"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1294),
                        ...
                        new
                        {
                            Id = new Guid("c67c3d7b-82b0-4e1f-996d-c95d2c05eec2"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1295),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("8edc339b-3e27-4e93-8f8b-4817bca5b170"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1297),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c25d0834-4d1a-434a-8271-1155c95c9090"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 3, 2, 12, 8, 29, 926, DateTimeKind.Local).AddTicks(1300),
