...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230503120553_RevenueM")]
    partial class RevenueM
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c63c34f-0ebc-46cd-b12b-64f8dfdb2f09"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8861),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("60343580-ad01-41e3-bbfc-06e7887f82d7"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8878),
                        ...
                        new
                        {
                            Id = new Guid("b4768979-0ab1-45ac-bdce-9af9bcf27127"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8883),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("efa2499d-b7d7-4769-af67-93750c6e1d85"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8885),
                        ...
                        new
                        {
                            Id = new Guid("245eea86-3c0b-4f53-bf9e-cb9106214a47"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8886),
                        ...
                        new
                        {
                            Id = new Guid("56e9bc2f-5828-4e4f-b08b-ba9e51666c5f"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8888),
                        ...
                        new
                        {
                            Id = new Guid("826b5173-d589-4d3d-abf9-b5d832b74917"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8889),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("f609b3e8-6afc-4ad6-b90a-3d2061c95510"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8891),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("53fbf41d-c868-4bff-9417-0bb413c17d80"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 3, 9, 5, 48, 775, DateTimeKind.Local).AddTicks(8894),
