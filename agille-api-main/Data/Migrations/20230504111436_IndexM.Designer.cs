...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230504111436_IndexM")]
    partial class IndexM
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("081053f0-7dd8-4b0e-9ae6-fdb03700243f"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9403),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ec788a02-cb4c-4209-be17-e4041acc3170"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9427),
                        ...
                        new
                        {
                            Id = new Guid("e31c5ed1-a184-4d90-bd14-fb528f806739"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9430),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ee4237b1-0fa7-497b-962b-9aea3d05743b"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9432),
                        ...
                        new
                        {
                            Id = new Guid("5bb2ffb6-dd38-44e0-b428-3fc370be65f3"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9434),
                        ...
                        new
                        {
                            Id = new Guid("10dc22cc-75af-4a32-a032-03219d418549"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9436),
                        ...
                        new
                        {
                            Id = new Guid("5a9d9d75-6315-41b7-ac4e-c1377dda3948"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9448),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("62eb25e1-ad7e-4a12-9077-54618445a86a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9451),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("efa080ff-5507-4372-a137-50b8a23d8b32"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 8, 14, 31, 789, DateTimeKind.Local).AddTicks(9452),
