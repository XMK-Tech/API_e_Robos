...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230504123338_RubricM")]
    partial class RubricM
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e3482a70-e46f-4508-b136-1ca8be44fefa"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4842),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a64a227d-bab0-4a8b-8314-87d2579f611e"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4859),
                        ...
                        new
                        {
                            Id = new Guid("0ed28e6a-bbd9-4165-b80e-5ca0917c7faa"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4861),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("369e164a-6cae-42e8-837e-2ce85b0ae29c"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4871),
                        ...
                        new
                        {
                            Id = new Guid("4c734644-bfef-4f6d-be7c-3a0462e44e2c"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4873),
                        ...
                        new
                        {
                            Id = new Guid("d7715a21-b87a-4a78-b3ef-2ebddb07e772"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4874),
                        ...
                        new
                        {
                            Id = new Guid("5131de7a-f662-4754-b814-acf9c3255e39"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4876),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("bc522b97-583a-4034-8603-18b4fb0c7e1c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4877),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b0e77212-2e7d-48db-a2c4-20e18d45eae6"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 4, 9, 33, 33, 560, DateTimeKind.Local).AddTicks(4878),
