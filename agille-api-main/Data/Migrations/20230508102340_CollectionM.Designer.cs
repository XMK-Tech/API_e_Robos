...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230508102340_CollectionM")]
    partial class CollectionM
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ea4a1764-f555-4e26-8051-78b5bfc24c74"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(4991),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a0fdbc00-4ec9-4c9a-91a6-81e659d3e7f2"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5007),
                        ...
                        new
                        {
                            Id = new Guid("96377bd3-9cc1-4951-a717-8e2287fcca59"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5022),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("9fcb1db9-9876-4bdc-bf70-f573bf5b2379"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5023),
                        ...
                        new
                        {
                            Id = new Guid("f0ea5392-3dd7-4e0d-81be-f66e606c5bbc"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5024),
                        ...
                        new
                        {
                            Id = new Guid("a6b11d9d-33dd-41c7-b126-2e9797193ede"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5030),
                        ...
                        new
                        {
                            Id = new Guid("979b5aa7-93c2-411a-931a-447810711b5d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5031),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("deea7f6d-b56a-4f1b-ba6d-15742d6a2282"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5033),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("98271e65-f9d8-44c1-9639-66956bc91e51"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 7, 23, 36, 71, DateTimeKind.Local).AddTicks(5034),
