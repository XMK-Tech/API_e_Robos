...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230508115313_ExpenseM")]
    partial class ExpenseM
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("99e9c654-a029-479b-a6d4-57ee87fd8327"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2931),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a93241d7-935f-4e18-9a4d-cef6f0f9b0a8"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2948),
                        ...
                        new
                        {
                            Id = new Guid("8b7fc5df-60b8-48d5-bef8-a3fd9bce78ab"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2950),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("01aaf7b5-173b-41cf-ae41-d01a05ea8b62"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2953),
                        ...
                        new
                        {
                            Id = new Guid("81654942-364b-405c-ad89-ae2d1e4b46f2"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2955),
                        ...
                        new
                        {
                            Id = new Guid("6686982f-e31d-4cc5-93de-7d5f09a5b2f1"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2958),
                        ...
                        new
                        {
                            Id = new Guid("efa29ce3-d34d-40d2-bb27-d4dd4b178f23"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2969),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("889ee450-5784-4d84-a4ab-7bcf1bff6ddb"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2972),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("bbb5ae27-7e91-4110-a023-49e714383da9"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 8, 8, 53, 7, 354, DateTimeKind.Local).AddTicks(2974),
