...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230511132514_FPMLaunchM")]
    partial class FPMLaunchM
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ed11af5d-955e-4ace-9c5f-e96c89a9c7e9"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8211),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("32729c53-079c-4562-b550-89cff3e0f733"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8225),
                        ...
                        new
                        {
                            Id = new Guid("0dc6b465-d670-4bb7-b7b9-91aa02e073da"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8227),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("037e3440-fce2-4aa8-9d47-d2032cfa009f"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8228),
                        ...
                        new
                        {
                            Id = new Guid("a36c7f34-c63b-4799-90a2-876b6648bc9a"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8230),
                        ...
                        new
                        {
                            Id = new Guid("732f7fc4-9986-4c6e-98f2-10e759152f6e"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8231),
                        ...
                        new
                        {
                            Id = new Guid("d83623a5-41de-4802-8731-a6f91156eb49"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8239),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("cd9368c8-6a31-4a47-a960-39739d5262da"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8240),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1ccd58de-2788-4468-8441-897e1cec00ae"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 11, 10, 25, 9, 903, DateTimeKind.Local).AddTicks(8242),
