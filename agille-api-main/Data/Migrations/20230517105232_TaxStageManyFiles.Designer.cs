...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230517105232_TaxStageManyFiles")]
    partial class TaxStageManyFiles
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e634c2d5-4850-4ee7-9c81-fb4581c16911"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(263),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("739caf5e-f0f8-41fc-9dd5-edb8edb5dd53"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(281),
                        ...
                        new
                        {
                            Id = new Guid("8bbceed1-a30c-4e67-b174-dab63a4a782d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(283),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("773c05a8-73bd-47d6-b85b-eb211cfd10e1"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(284),
                        ...
                        new
                        {
                            Id = new Guid("8bc5a2e0-e620-4204-a3f7-05ac3346db7b"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(286),
                        ...
                        new
                        {
                            Id = new Guid("cdb157bb-f1c6-4d3e-b012-b66f72d4e921"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(295),
                        ...
                        new
                        {
                            Id = new Guid("b3437bcb-bc15-46ef-a140-3ed2d6fec56f"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(296),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("0a9cc927-aa35-485d-a014-bf59dc863332"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(298),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("d1728202-1ef6-43a3-8869-4d43f7097c16"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 17, 7, 52, 28, 940, DateTimeKind.Local).AddTicks(299),
