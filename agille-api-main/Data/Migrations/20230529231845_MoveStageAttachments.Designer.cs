...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230529231845_MoveStageAttachments")]
    partial class MoveStageAttachments
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("749fafef-9959-4338-8483-f3bb447898f6"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3518),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("fd7fd5c9-261e-4c16-a185-c1c4a77922cc"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3651),
                        ...
                        new
                        {
                            Id = new Guid("3638ff69-1bc3-45b4-9e0b-f3d31aa53c04"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3653),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("339ab83f-0b12-4cf6-bb18-210daf6e48b2"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3655),
                        ...
                        new
                        {
                            Id = new Guid("648fd6e1-b7c7-4096-9702-bded7322ddc8"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3658),
                        ...
                        new
                        {
                            Id = new Guid("d336f657-b572-4c44-acaf-0445b744c991"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3670),
                        ...
                        new
                        {
                            Id = new Guid("967d541f-5983-4b35-805f-e29ecf0b5520"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3672),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("19a08d3c-e47d-4839-ac46-d38a642cfbab"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3676),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a582bd07-18d5-48ba-b79b-f5e58c02aeff"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 29, 20, 18, 40, 464, DateTimeKind.Local).AddTicks(3682),
