...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230531223707_OperatorServer_v1")]
    partial class OperatorServer_v1
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f627f2e4-f99c-439f-8bc9-57f032bffada"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5437),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("b0963e49-6f75-4c6c-95e1-443247ea7acc"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5719),
                        ...
                        new
                        {
                            Id = new Guid("0e4c01e4-737f-4683-a834-2924be5ca02f"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5721),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("3c92f158-b376-4fd4-884a-728f90893117"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5722),
                        ...
                        new
                        {
                            Id = new Guid("96a198f4-ef57-4047-9870-f8328ae98d34"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5724),
                        ...
                        new
                        {
                            Id = new Guid("ffeced63-3fab-4eaf-b449-1c81f0673f83"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5725),
                        ...
                        new
                        {
                            Id = new Guid("fc23e503-8395-4221-9802-f2149265e3fe"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5740),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("9820f6de-5027-410b-b23b-6dba6461cb96"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5742),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("9fb00898-baca-41a8-9cf4-552883a789b3"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 5, 31, 19, 37, 0, 37, DateTimeKind.Local).AddTicks(5743),
