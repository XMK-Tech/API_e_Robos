...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230601202208_PersonalDocumentNotMandatory")]
    partial class PersonalDocumentNotMandatory
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("76655464-737b-4951-97cf-e23c29f48c52"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2106),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("d26368a9-8270-4421-8e4d-3f81aedda71d"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2122),
                        ...
                        new
                        {
                            Id = new Guid("2d206cd1-2332-4185-aa9e-71cfaed4733b"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2131),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("8e58ed02-8379-4eb9-a760-b0267989d412"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2132),
                        ...
                        new
                        {
                            Id = new Guid("7f8adad8-7284-4b9a-872b-3ad0ae29418d"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2133),
                        ...
                        new
                        {
                            Id = new Guid("e5b20684-469b-4451-a235-70417cdf2b42"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2135),
                        ...
                        new
                        {
                            Id = new Guid("bf16c135-3dac-4dbc-ae51-e4e29a8ce54a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2136),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("49f7425b-db87-43f8-a648-1bae1d0b8e49"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2137),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("fa2f4394-bb91-4fa5-8655-c4f27fa20164"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 1, 17, 22, 2, 742, DateTimeKind.Local).AddTicks(2138),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.RubricAccount", b =>
                {
                    ...
                    b.Property<bool>("Classifications")
                        .HasColumnType("bit");
