...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230602111304_removeRevenueIndexGeneration")]
    partial class removeRevenueIndexGeneration
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("52d21459-dd8d-4053-ac8f-981c9aee0cda"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5612),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("ecb4c84e-068e-4363-8073-2de086de3a31"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5628),
                        ...
                        new
                        {
                            Id = new Guid("444ff7f6-1133-4e33-bdfe-b913e3da5f2a"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5630),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1ef24d85-e449-49b3-8353-bffe1aaae3f4"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5632),
                        ...
                        new
                        {
                            Id = new Guid("6c70f2c2-e2f7-41ac-b4d1-028d75457145"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5635),
                        ...
                        new
                        {
                            Id = new Guid("bd6221b1-2baa-41dc-9097-0a0f807ee349"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5637),
                        ...
                        new
                        {
                            Id = new Guid("ca028018-9119-453d-9327-82411219e2f1"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5639),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("738e3a3a-f755-4360-87ac-b327138ab4ac"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5653),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e22bd683-d29c-41b0-973c-ab12d28575a5"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 2, 8, 13, 0, 204, DateTimeKind.Local).AddTicks(5656),
