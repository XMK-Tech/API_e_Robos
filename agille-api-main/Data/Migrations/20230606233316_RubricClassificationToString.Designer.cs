...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230606233316_RubricClassificationToString")]
    partial class RubricClassificationToString
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("37f8c9ee-b29b-48fb-be0a-ed3e036d869c"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4392),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("52eb42f8-06f3-405e-8922-82e08ab6acdf"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4407),
                        ...
                        new
                        {
                            Id = new Guid("cec71c71-d5d5-471d-b107-fd9dc6be987b"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4409),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("1c0e09e4-a261-4dfd-9efd-057ea8374684"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4410),
                        ...
                        new
                        {
                            Id = new Guid("c8a8df44-0e4f-413a-bc03-254fbfeb5cdf"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4411),
                        ...
                        new
                        {
                            Id = new Guid("f8b311f7-929a-49b9-8eaf-a83a5e7aec60"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4413),
                        ...
                        new
                        {
                            Id = new Guid("9ba98ec2-e2ec-4034-b2a2-2c0554dfac06"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4423),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("7ae8c7aa-b54d-4b0a-925e-53ec985fda8b"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4424),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("b42f00e5-f236-4cc9-b585-1a055cd2051f"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 6, 20, 33, 11, 218, DateTimeKind.Local).AddTicks(4426),
