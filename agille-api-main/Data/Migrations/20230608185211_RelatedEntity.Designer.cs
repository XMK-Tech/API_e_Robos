...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230608185211_RelatedEntity")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a6645a34-8ada-407f-9b77-07930811bc33"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8393),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("6675bf1f-9ab7-49eb-9fe2-3e93ad647c31"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8429),
                        ...
                        new
                        {
                            Id = new Guid("cc6940ec-d9d4-49b5-a934-1a17c5e11e6a"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8431),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("343e50b5-28dc-41f0-8632-9f35de4dcffa"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8434),
                        ...
                        new
                        {
                            Id = new Guid("29c1c4d2-1514-4f4d-becf-f92f97b0b4e9"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8436),
                        ...
                        new
                        {
                            Id = new Guid("5a8ba6d7-d7b9-4913-9968-cff0615a3e06"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8464),
                        ...
                        new
                        {
                            Id = new Guid("ef04fcf6-5134-4faf-9ae4-d71ddd2e7c59"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8467),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("ea2c50df-e7b9-435b-b377-f8ca89fc6c59"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8469),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("ebe1d7bb-44b6-4cbc-9e49-9faf2775d27b"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 8, 15, 52, 5, 589, DateTimeKind.Local).AddTicks(8471),
