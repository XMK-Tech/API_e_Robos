...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230615104827_FixRevenueReferenceAndIndex")]
    partial class FixRevenueReferenceAndIndex
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d84a4235-a7e2-4330-8b50-5990867af9d6"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3283),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("d08cd6fe-261f-4ec4-8e06-e6783f71d77f"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3298),
                        ...
                        new
                        {
                            Id = new Guid("e26bff2a-8ee1-43d8-85e4-e14d0f49ba9e"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3300),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("222a2c11-1b1f-41e3-90ff-a75ea2e11072"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3301),
                        ...
                        new
                        {
                            Id = new Guid("34f53f3b-60f4-4176-9191-9447404c0e28"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3302),
                        ...
                        new
                        {
                            Id = new Guid("dfd0be4a-105b-4392-aad6-b74ce5d36b49"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3304),
                        ...
                        new
                        {
                            Id = new Guid("4c2eceb4-e9b4-4a2e-bb3f-3deff54d9cef"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3305),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("ddf010f6-aa50-40c7-958a-318e6ddd707a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3313),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("0bea331f-d5c6-4d62-9f86-f9f173361b68"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 7, 48, 22, 36, DateTimeKind.Local).AddTicks(3315),
