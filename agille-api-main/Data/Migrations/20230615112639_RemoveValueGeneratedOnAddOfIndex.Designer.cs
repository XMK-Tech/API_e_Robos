...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230615112639_RemoveValueGeneratedOnAddOfIndex")]
    partial class RemoveValueGeneratedOnAddOfIndex
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8d05499d-9258-49b1-b283-a71bdb46d762"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1022),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("2e67250a-7eff-4eda-94ca-dc3d5260cca2"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1039),
                        ...
                        new
                        {
                            Id = new Guid("6882a2ea-73fd-4d48-abef-5bb97a6d035d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1041),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("7201ebc3-2194-4ccb-bc5e-14ea83629eee"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1044),
                        ...
                        new
                        {
                            Id = new Guid("6f474e77-25f9-4e72-a6c8-bcfa9d639f55"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1046),
                        ...
                        new
                        {
                            Id = new Guid("a3bf9eaf-cece-4340-b3f5-eb970623d203"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1048),
                        ...
                        new
                        {
                            Id = new Guid("4fafa51c-48b8-4fe0-9a4d-a918ed84cbd9"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1051),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("4ad93323-d1f8-404f-b301-5e1d7c08a420"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1066),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e823bf02-c8cb-45d1-ace3-3d268585b38a"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 6, 15, 8, 26, 33, 515, DateTimeKind.Local).AddTicks(1069),
