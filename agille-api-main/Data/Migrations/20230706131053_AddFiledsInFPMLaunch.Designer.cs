...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230706131053_AddFiledsInFPMLaunch")]
    partial class AddFiledsInFPMLaunch
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4cb3b38d-eca6-4b8e-8a17-7828a6a2dd52"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2730),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("76d4044a-d460-46e9-86f8-4cb509b83629"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2752),
                        ...
                        new
                        {
                            Id = new Guid("14507a5a-4c4f-4069-b6c7-784a1dca6240"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2754),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("98c6daa4-1522-4035-b119-0fdc973c9b1c"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2755),
                        ...
                        new
                        {
                            Id = new Guid("d7dc4df2-8e08-4cdf-99b4-3bff85ea30f4"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2757),
                        ...
                        new
                        {
                            Id = new Guid("6ef926f5-f989-4889-96f6-1d8c4177757a"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2759),
                        ...
                        new
                        {
                            Id = new Guid("b9d0eb3e-46f2-468f-ae30-091d68231118"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2769),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("a51219e3-6e9c-41ac-93af-b4100760c536"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2771),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("4ae469de-da76-4faa-b818-883226062034"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 6, 10, 10, 47, 613, DateTimeKind.Local).AddTicks(2772),
