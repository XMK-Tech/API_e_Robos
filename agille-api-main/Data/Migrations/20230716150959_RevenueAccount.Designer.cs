...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230716150959_RevenueAccount")]
    partial class RevenueAccount
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1ef141cb-7597-48d7-9fbb-e4ef024739c5"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4376),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("b0c2c640-49c2-426e-9dd3-7f065af94995"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4396),
                        ...
                        new
                        {
                            Id = new Guid("adeae847-6f2b-425f-8cff-1973ea5ad838"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4398),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("01e3f27c-e720-4e06-951b-77b9dc1e2426"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4399),
                        ...
                        new
                        {
                            Id = new Guid("7ee66f6e-8244-4892-83c3-58d17c765fe1"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4400),
                        ...
                        new
                        {
                            Id = new Guid("b60d5afd-cc0d-45c0-a927-c0db5774a539"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4414),
                        ...
                        new
                        {
                            Id = new Guid("f8f82ae6-19f9-4924-86ba-493e37bc8fb8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4415),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("6df401c5-0372-4b42-afa3-3bb7b165ffe6"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4417),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("55a0dcb7-4816-4dc5-9a36-6cfb1e74fd4c"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 16, 12, 9, 54, 837, DateTimeKind.Local).AddTicks(4418),
