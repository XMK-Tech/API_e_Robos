...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230717125742_ExpenseType")]
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cb9ca6ef-7f3d-4278-a8dc-5ba6db9ee28d"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8599),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("97b0789e-eaf5-4818-a49b-80fd366e5a16"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8614),
                        ...
                        new
                        {
                            Id = new Guid("cdc5a020-e97a-4dca-8bf1-e98a8fbc7d82"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8615),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("88998412-5a45-44c6-9c57-305dbb657943"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8617),
                        ...
                        new
                        {
                            Id = new Guid("3c1e2953-4f43-4d85-802a-0e10aca6cf11"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8618),
                        ...
                        new
                        {
                            Id = new Guid("7fbd3e57-141f-4fbd-9fe0-6a6061df26b7"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8620),
                        ...
                        new
                        {
                            Id = new Guid("7ab0f679-d5a2-4a47-899f-8c88161f71ce"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8621),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("3e4c2228-df4f-4254-b1a8-cede94ffb960"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8622),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c27297bd-bedb-4182-93b2-9d19f3780430"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 17, 9, 57, 38, 707, DateTimeKind.Local).AddTicks(8626),
