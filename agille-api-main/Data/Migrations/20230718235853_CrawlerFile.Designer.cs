...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230718235853_CrawlerFile")]
    partial class CrawlerFile
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("97d454a9-432d-4641-9e03-fcf378f29438"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3397),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("39471a10-041c-45dc-b7f9-cee6bab79759"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3412),
                        ...
                        new
                        {
                            Id = new Guid("4d47284d-ef51-46ec-8f19-39cb1df1a735"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3414),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("514acc24-c235-4e81-83ad-343aba9a25d4"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3415),
                        ...
                        new
                        {
                            Id = new Guid("2645eaf2-a5b0-41af-b486-74a5e75c65f2"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3432),
                        ...
                        new
                        {
                            Id = new Guid("55952d31-f1e4-45b9-affc-21a743d67612"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3434),
                        ...
                        new
                        {
                            Id = new Guid("0d9f85f3-42b6-4424-a396-9031d95cd6a8"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3435),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("b7859d0e-6b76-4a81-97be-8ca5c21577fd"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3436),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("20db6234-fb6d-4594-8023-dc8a4624cdda"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 18, 20, 58, 48, 134, DateTimeKind.Local).AddTicks(3438),
