...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230728111925_RelatedEntityIdentifiers")]
    partial class RelatedEntityIdentifiers
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ec3fb199-f681-4c60-8e09-2c829aa0623b"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9766),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("556e724b-4cda-4ad5-8559-6d639f83e366"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9782),
                        ...
                        new
                        {
                            Id = new Guid("38d3559b-219c-4246-847e-e1f5baaf0a0d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9784),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("a4d799ce-6325-4be8-85ba-85a1476d2536"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9786),
                        ...
                        new
                        {
                            Id = new Guid("5b00c4cc-524e-4ffe-b07e-85f730dea354"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9789),
                        ...
                        new
                        {
                            Id = new Guid("9c57b3cb-5bd3-448c-bc85-36b3a9a668c8"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9805),
                        ...
                        new
                        {
                            Id = new Guid("fa8cd34f-be22-4ad3-9fc3-38e536c11fdc"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9807),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("ffa40514-e117-4dcb-a6bf-e1f35466ea6f"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9809),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("3e7fe08c-ace7-4e31-b5ae-04a88c0bfc13"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 7, 28, 8, 19, 20, 491, DateTimeKind.Local).AddTicks(9813),
