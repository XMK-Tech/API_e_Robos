...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230803104536_ProprietyAreaDeclarations")]
    partial class ProprietyAreaDeclarations
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a7ae6717-fcaa-4120-8b57-0a4b19877da1"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7952),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("2367fb8a-b7fd-4694-ba97-445ba8688bcd"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7975),
                        ...
                        new
                        {
                            Id = new Guid("48bcdebb-846c-4591-90db-a06c87ab3c58"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7976),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("878ddd21-c371-42aa-9e4b-af39fdb5f34a"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7978),
                        ...
                        new
                        {
                            Id = new Guid("45157cae-95e5-4136-bd8e-dc8552b3db0b"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7979),
                        ...
                        new
                        {
                            Id = new Guid("fae99031-b5be-4fb0-abdf-20333a29b725"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7981),
                        ...
                        new
                        {
                            Id = new Guid("b80e6170-d5c9-43ba-81e3-6e102376184d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7996),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("30a54090-40b8-4942-8665-bda5fae9fcd0"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7998),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("29e07ee3-ee80-40f3-ba4d-5d0d20f266ee"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 7, 45, 31, 473, DateTimeKind.Local).AddTicks(7999),
