...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230803110231_OptionalCertificationDate")]
    partial class OptionalCertificationDate
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("94fa3c43-5b7a-4b8d-a419-64935353f29b"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(748),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("7ab0919a-ad0d-4aa9-b82e-20971214a4a8"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(775),
                        ...
                        new
                        {
                            Id = new Guid("70e43e47-5f78-47f8-859b-b8f9188e6e95"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(778),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("819fadd5-992d-4f40-a6d2-2bd449ca1835"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(780),
                        ...
                        new
                        {
                            Id = new Guid("d1d2dd1e-51c0-4e64-8de5-baeba4175c12"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(781),
                        ...
                        new
                        {
                            Id = new Guid("7ab69543-6a9a-4df9-84c1-2728581d8cfd"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(784),
                        ...
                        new
                        {
                            Id = new Guid("53157dbf-0485-47d6-aee4-62c2d2b0fec9"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(786),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("9c46ea2c-b513-4769-8814-e26a22a0d110"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(788),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("526cfbb6-5df8-4277-862b-f43dc4651938"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 8, 3, 8, 2, 26, 905, DateTimeKind.Local).AddTicks(795),
