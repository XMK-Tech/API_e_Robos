...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230920125539_OverridePreviousImport")]
    partial class OverridePreviousImport
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7a6c246f-ba58-4a1d-b703-818e10b5d444"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4685),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("6b58bf93-6d5c-4860-ae93-3e557707be0a"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4699),
                        ...
                        new
                        {
                            Id = new Guid("f71bcbc1-9e37-4723-8691-b10f8e9457d2"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4701),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("43620abe-3c95-44c4-9903-1ddb94262c2f"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4702),
                        ...
                        new
                        {
                            Id = new Guid("fed4b041-d6ad-4e25-8aa5-5e6cf5e37a46"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4703),
                        ...
                        new
                        {
                            Id = new Guid("6d1bc5f5-8a80-4350-a333-8c4d16cc47a6"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4705),
                        ...
                        new
                        {
                            Id = new Guid("a95607c2-1601-4bed-a557-599431885f8a"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4717),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("6a4324f4-f210-4fde-81cc-186c524645a4"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4719),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("d1476f07-bb13-4d87-9617-b0b934352777"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 9, 55, 34, 465, DateTimeKind.Local).AddTicks(4720),
