...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20230920135247_FixExpenseReference")]
    partial class FixExpenseReference
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("569276e5-2e0c-4c81-b223-1c3e6f79794b"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9161),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("a1bf10c3-0f7a-41b4-a63a-7a2901dfd363"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9177),
                        ...
                        new
                        {
                            Id = new Guid("a1c8783c-fdbe-4b5a-a81d-38962a84342d"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9179),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("e07a0c7f-1bc6-4473-9748-20cc3b0d3cea"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9180),
                        ...
                        new
                        {
                            Id = new Guid("df9839bc-d2eb-4c30-aa00-a1d8cfe178b8"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9181),
                        ...
                        new
                        {
                            Id = new Guid("a63cc665-e280-427d-a5d8-67bfdf6a4ab5"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9200),
                        ...
                        new
                        {
                            Id = new Guid("0c3fd70e-a23d-475d-89c9-5666d18e4431"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9201),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("90bce2c0-fd7c-4b05-859f-b51f5171358c"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9202),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("d8ec8ea0-c9a0-490c-9a2a-aa972adee329"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2023, 9, 20, 10, 52, 41, 573, DateTimeKind.Local).AddTicks(9204),
