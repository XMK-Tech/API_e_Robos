...
namespace AgilleApi.Data.Migrations
{
    ...
    [Migration("20240406221242_AddGoodSuitabilityFarming")]
    partial class AddGoodSuitabilityFarming
    {
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.CollectionAttachment", b =>
                {
                    ...
                    b.ToTable("CollectionAttachments");
                });
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.DynamicFieldOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c8fc64c4-a838-40d8-9726-ad5979e56cf4"),
                            Code = "[[user-token]]",
                            Column = "SetPasswordToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4458),
                            DisplayColumn = "Token",
                            DisplayTable = "User",
                        ...
                        new
                        {
                            Id = new Guid("1170148c-ffb8-440c-b003-64c169e5a004"),
                            Code = "[[confirmation-token]]",
                            Column = "ConfirmationToken",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4477),
                        ...
                        new
                        {
                            Id = new Guid("78d05b3c-caf1-4bff-a401-3497cf83d691"),
                            Code = "[[person-name]]",
                            Column = "Name",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4479),
                            DisplayColumn = "Nome",
                            DisplayTable = "Pessoa",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("c4e7ae3a-a306-436c-b9dc-1a6e6b689cc8"),
                            Code = "[[person-document]]",
                            Column = "Document",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4480),
                        ...
                        new
                        {
                            Id = new Guid("72096949-4334-4fb4-aca1-4dad5bbc59a8"),
                            Code = "[[person-display-name]]",
                            Column = "DisplayName",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4481),
                        ...
                        new
                        {
                            Id = new Guid("ecb55701-c5de-4817-a8e7-2eeabc937381"),
                            Code = "[[description]]",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4482),
                        ...
                        new
                        {
                            Id = new Guid("29bb2704-217f-4dbc-ad2c-15a09ad85a98"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4484),
                            DisplayColumn = "Url",
                        ...
                        new
                        {
                            Id = new Guid("f2fb5515-392d-404e-9fe3-f8874858c80d"),
                            Code = "[[attachment-url]]",
                            Column = "Url",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4499),
                            DisplayColumn = "Url",
                            DisplayTable = "Attachment",
                            LastUpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Schema = "[dbo]",
                        ...
                        new
                        {
                            Id = new Guid("2d286d4b-b661-48cd-83ee-28606028c394"),
                            Code = "[[phone-number]]",
                            Column = "Number",
                            ColumnKey = "Id",
                            CreatedAt = new DateTime(2024, 4, 6, 19, 12, 41, 826, DateTimeKind.Local).AddTicks(4500),
            ...
            modelBuilder.Entity("AgilleApi.Domain.Entities.TaxPayerDeclaration", b =>
                {
                    ...
                    b.ToTable("TaxPayerDeclarations");
                });
